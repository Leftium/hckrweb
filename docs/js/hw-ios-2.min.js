...
},a.hnapi=r}(window),function(a,b){"function"==typeof define&&define.amd?define("tappable",[],function(){return b(a,window.document),a.tappable}):b(a,window.document)}(this,function(a,b){var c=Math.abs,d=function(){},e={noScroll:!1,activeClass:"tappable-active",onTap:d,onStart:d,onMove:d,onMoveOut:d,onMoveIn:d,onEnd:d,onCancel:d,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},f="ontouchend"in document,g={start:f?"touchstart":"mousedown",move:f?"touchmove":"mousemove",end:f?"touchend":"mouseup"},h=function(a,c){var d=b.elementFromPoint(a,c);
...
window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),e=window.setTimeout(function(){b(c+d)},d);return a=c+d,e}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}();var relativeDate=function(a){function b(b,c){!c&&(c=(new Date).getTime()),c instanceof Date&&(c=c.getTime()),b instanceof Date&&(b=b.getTime());var d,e,f,g=c-b;for(e=-1,f=j.length;++e<f;)if(d=j[e],g<d[0])return d[2]==a?d[1]:Math.round(g/d[2])+" "+d[1]
