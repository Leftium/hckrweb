...
f.comments.currentID=null,ruto.reload()}},f.init=function(){f.news.render(),ruto.init()},a.hw=f,ruto.config({before:function(a,b){f.hideAllViews();var d=c("view-"+b);d.classList.remove("hidden"),f.currentView=b,f.setTitle(d.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(a,b){f.comments.render(b)})}(window),function(a){var b=a.document,c=b.body,d=["webkit","moz","MS","o",""],e=d.length,f=function(a,b,c){
for(var f=0;f<e;f++)d[f]||(b=b.toLowerCase()),a.addEventListener(d[f]+b,c,!1)},g=function(a,b,c){for(var f=0;f<e;f++)d[f]||(b=b.toLowerCase()),a.removeEventListener(d[f]+b,c,!1)},h={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},i=function(a){var b=a.in,c=a.out,d=b.classList,e=c.classList,i=a.direction,j=h[i],k=function(){e.add("hidden"),e.remove(j[0]),d.remove(j[1]),g(b,"AnimationEnd",k)};f(b,"AnimationEnd",k),d.remove("hidden"),d.add(j[1]),e.add(j[0]);
},j=function(a){var b=a.in,c=a.out,d=b.classList,e=c.classList,h=a.direction;if("up"==h)e.add("no-pointer"),d.remove("hidden"),d.add("slide-up");else{var i=function(){e.remove("slide-down"),e.add("hidden"),d.remove("no-pointer"),g(c,"AnimationEnd",i)};f(c,"AnimationEnd",i),e.remove("slide-up"),e.add("slide-down")}},k=function(){return(c.offsetWidth||a.innerWidth)>736?"wide":"narrow"},l=b.querySelector("meta[name=viewport]");l||(l=b.createElement("meta"),l.name="viewport",b.head.appendChild(l)),l.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";
var m="wide"==k();a.addEventListener("resize",function(){var a="wide"==k();a!=m&&(m=a,location.reload())}),m&&c.insertAdjacentHTML("beforeend",'<div id="overlay" class="hide"></div>');var n=!1;document.addEventListener("touchstart",function(a){var b=a.targetTouches[0],c=b.clientX;(c<20||c>window.innerWidth-20)&&(n=!0)}),document.addEventListener("touchend",function(a){n=!1}),ruto.config({before:function(a,b,c){var d=hw.previousView=hw.currentView,e=hw.currentView=b,f=hw.hideAllViews,g=$("view-"+e);
...
});"undefined"!=typeof ga&&ga("send","pageview",a);break;case"comments":if(m)f(),$("overlay").classList.add("hide"),g.classList.remove("hidden"),$("view-home").classList.remove("hidden"),hw.pub("selectCurrentStory",c[1]),g.querySelector("header a.header-back-button").style.display="";else if("home"!=d||n)f(),g.classList.remove("hidden");else{var l=c[1];l&&hw.comments.currentID!=l&&(g.querySelector("section").scrollTop=0),i({in:g,out:$("view-"+d),direction:"rtl"})}}}}),a.addEventListener("pagehide",function(){
for(var a=b.querySelectorAll(".view"),c={},d=0,e=a.length;d<e;d++){var f=a[d];c[f.id]=f.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",c)},!1);var o=function(){var a=amplify.store("hacker-scrolltops");for(var b in a){var c=$(b).querySelector(".scroll section");c.scrollTop=a[b]}};a.addEventListener("pageshow",o,!1),o(),tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(a,b){var c=b.hash;m&&/about/i.test(ruto.current)&&"#/"==c?ruto.back("/"):location.hash=c;
...
b.stop(),p=!1,delete b}).start(),e=function(){TWEEN.update(),requestAnimationFrame(e)};a=requestAnimationFrame(e)},200)}}});var q;if(tappable("#view-home .tableview-links li>a:first-child",{allowClick:!m,activeClassDelay:100,inactiveClassDelay:m?100:1e3,onStart:function(a,b){if(m){var c=b.parentNode;c&&(c=c.parentNode,q=setTimeout(function(){c&&c.classList.add("list-tapped")},100))}},onMove:function(){m&&clearTimeout(q)},onEnd:function(a,b){if(m){clearTimeout(q);var c=b.parentNode.parentNode;setTimeout(function(){
c&&c.classList.remove("list-tapped")},100)}},onTap:function(b,c){c.classList.contains("more-link")?hw.news.more(c):/^#\//.test(c.getAttribute("href"))?location.hash=c.hash:c.href&&m&&a.open(c.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("button.comments-toggle",function(a,b){hw.comments.toggle(b)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){
if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;d<e;d++)c[d].classList.remove("selected");if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()},1))}}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload();
},1)},!1),m){var r=$("apploader");r.parentNode.removeChild(r)}else setTimeout(function(){var a=$("apploader");a&&(a.classList.add("hide"),f(a,"TransitionEnd",function(){a.parentNode.removeChild(a)}))},200);m&&setTimeout(function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!m,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",
a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();
