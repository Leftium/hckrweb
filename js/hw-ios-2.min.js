...
},1))}}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),m){var r=$("apploader");r.parentNode.removeChild(r)}else setTimeout(function(){var a=$("apploader");a&&(a.classList.add("hide"),f(a,"TransitionEnd",function(){a.parentNode.removeChild(a)}))},200);m&&setTimeout(function(){$("view-about").classList.add("animated")},400),
hw.news.options.disclosure=!m,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();
