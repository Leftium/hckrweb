...
y.setTitle(n.title),S.innerHTML=n.title;var e=i.render(n,{comments_list:e}),s=w.createElement("div");s.innerHTML=e;for(var a=s.querySelectorAll("a"),u=0,l=a.length;u<l;u++)a[u].target="_blank";var c=n.user;if(c)for(var f=s.querySelectorAll(".user"),u=0,l=f.length;u<l;u++){var d=f[u];d.textContent.trim()==c&&(d.classList.add("op"),d.title="Original Poster")}if(2e4<e.length)for(var h=s.querySelectorAll(".comments>ul>li>ul"),m=g("comments-toggle"),p=0,l=h.length;p<l;p++){var v=h[p],
...
n.querySelector("[name=hw-appearance][value="+s+"]").checked=!0):(/(light|dark)/i.test(s)||(s="light"),n.querySelector('[name=hw-appearance][value="'+s+'"]').checked=!0),n.onclick=function(){var e=n.querySelector("[name=hw-appearance]:checked").value;localStorage.setItem(o,e),a(e)}):setTimeout(e,1e3)}()},e.hw=y,ruto.config({before:function(e,t){y.hideAllViews();var n=l("view-"+t);n.classList.remove("hidden"),y.currentView=t,y.setTitle(n.querySelector("header h1").textContent)},notfound:function(
){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){y.comments.render(t)})}(window),function(n){function a(e,t,n){for(var i=0;i<s;i++)r[i]||(t=t.toLowerCase()),e.addEventListener(r[i]+t,n,!1)}function u(e,t,n){for(var i=0;i<s;i++)r[i]||(t=t.toLowerCase()),e.removeEventListener(r[i]+t,n,!1)}function l(e){var t=e.in,n=e.out,i=t.classList,r=n.classList,e=e.direction,o=f[e],s=function(){r.add("hidden"),r.remove(o[0]),i.remove(o[1]),u(t,
"AnimationEnd",s)};a(t,"AnimationEnd",s),i.remove("hidden"),i.add(o[1]),r.add(o[0])}function c(e){var t,n=e.in,i=e.out,r=n.classList,o=i.classList;"up"==e.direction?(o.add("no-pointer"),r.remove("hidden"),r.add("slide-up")):(a(i,"AnimationEnd",t=function(){o.remove("slide-down"),o.add("hidden"),r.remove("no-pointer"),u(i,"AnimationEnd",t)}),o.remove("slide-up"),o.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var o=n.document,e=o.body,r=["webkit","moz",
...
n.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),d&&setTimeout(function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!d,hw.init()}(window);
