!function(t){function e(){}function n(){var e=location.hash.slice(1),t=!1,n=f.current,e=e||l.defaultPath;n&&n!=f.previous&&(f.previous=n),f.current=e;for(var i=0,r=c.length;i<r&&!t;i++){var o=c[i],s=o.path,a=o.name,u=o.fn;"string"==typeof s?s.toLowerCase()==e.toLowerCase()&&(l.before.call(f,s,a),u.call(f),l.on.call(f,s,a),t=!0):(o=e.match(s))&&(l.before.call(f,s,a,o),u.apply(f,o),l.on.call(f,s,a,o),t=!0)}return t||l.notfound.call(f),f}var c=[],l={defaultPath:"/",before:e,on:e,notfound:e},f={
current:null,previous:null,config:function(e){for(var t in e)e.hasOwnProperty(t)&&(l[t]=e[t]);return f},add:function(e,t,n){return e&&t&&("function"==typeof t&&(n=t,t=null),c.push({path:e,name:t,fn:n||function(){}})),f},go:function(e){return location.hash=e,f},back:function(e){return f.previous?(history.back(),f.previous=null):e&&(location.hash=e),f}};f.init=function(e){return t.addEventListener("hashchange",n),n()},f.reload=n,t.ruto=f}(window),function(e,d){var h=e.store=function(e,t,n){
var i=h.type;return n&&n.type&&n.type in h.types&&(i=n.type),h.types[i](e,t,n||{})};h.types={},h.type=null,h.addType=function(i,e){h.type||(h.type=i),h.types[i]=e,h[i]=function(e,t,n){return(n=n||{}).type=i,h(e,t,n)}},h.error=function(){return"amplify.store quota exceeded"};var t,i,r,f=/^__amplify__/;function n(c,l){h.addType(c,function(t,e,n){var i,r,o,s,a=e,u=(new Date).getTime();if(!t){a={},s=[],o=0;try{for(t=l.length;t=l.key(o++);)f.test(t)&&((r=JSON.parse(l.getItem(t))
).expires&&r.expires<=u?s.push(t):a[t.replace(f,"")]=r.data);for(;t=s.pop();)l.removeItem(t)}catch(e){}return a}if(t="__amplify__"+t,e===d){if(!((r=(i=l.getItem(t))?JSON.parse(i):{expires:-1}).expires&&r.expires<=u))return r.data;l.removeItem(t)}else if(null===e)l.removeItem(t);else{r=JSON.stringify({data:e,expires:n.expires?u+n.expires:null});try{l.setItem(t,r)}catch(e){h[c]();try{l.setItem(t,r)}catch(e){throw h.error()}}}return a})}for(t in{localStorage:1,sessionStorage:1})try{
window[t].setItem("__amplify__","x"),window[t].removeItem("__amplify__"),n(t,window[t])}catch(e){}if(!h.types.localStorage&&window.globalStorage)try{n("globalStorage",window.globalStorage[window.location.hostname]),"sessionStorage"===h.type&&(h.type="globalStorage")}catch(e){}function o(e){return e===d?d:JSON.parse(JSON.stringify(e))}!function(){if(!h.types.localStorage){var l=document.createElement("div"),f="amplify";l.style.display="none",document.getElementsByTagName("head")[0].appendChild(l)
;try{l.addBehavior("#default#userdata"),l.load(f)}catch(e){return l.parentNode.removeChild(l)}h.addType("userData",function(t,e,n){l.load(f);var i,r,o,s,a,u=e,c=(new Date).getTime();if(!t){for(u={},a=[],s=0;i=l.XMLDocument.documentElement.attributes[s++];)(r=JSON.parse(i.value)).expires&&r.expires<=c?a.push(i.name):u[i.name]=r.data;for(;t=a.pop();)l.removeAttribute(t);return l.save(f),u}if(t=(t=t.replace(
/[^\-._0-9A-Za-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c-\u200d\u203f\u2040\u2070-\u218f]/g,"-")).replace(/^-/,"_-"),e===d){if(!((r=(i=l.getAttribute(t))?JSON.parse(i):{expires:-1}).expires&&r.expires<=c))return r.data;l.removeAttribute(t)}else null===e?l.removeAttribute(t):(o=l.getAttribute(t),r=JSON.stringify({data:e,expires:n.expires?c+n.expires:null}),l.setAttribute(t,r));try{l.save(f)}catch(e){null===o?l.removeAttribute(t):l.setAttribute(t,o),h.userData();try{l.setAttribute(t,r)
,l.save(f)}catch(e){throw null===o?l.removeAttribute(t):l.setAttribute(t,o),h.error()}}return u})}}(),i={},r={},h.addType("memory",function(e,t,n){return e?t===d?o(i[e]):(r[e]&&(clearTimeout(r[e]),delete r[e]),null===t?(delete i[e],null):(i[e]=t,n.expires&&(r[e]=setTimeout(function(){delete i[e],delete r[e]},n.expires)),t)):o(i)})}(this.amplify=this.amplify||{});var Hogan={};!function(e){function l(e,t,n){var i;return t&&"object"==typeof t&&(
...
function a(){}a.prototype=(s.prototype=e).subs;var u=new s;for(var c in u.subs=new a,u.subsText={},u.buf="",i=i||{},u.stackSubs=i,u.subsText=o,t)i[c]||(i[c]=t[c]);for(c in i)u.subs[c]=i[c];for(c in r=r||{},u.stackPartials=r,n)r[c]||(r[c]=n[c]);for(c in r)u.partials[c]=r[c];return u}(i,n.subs,n.partials,this.stackSubs,this.stackPartials,t.stackText)}return this.partials[e].instance=i},rp:function(e,t,n,i){e=this.ep(e,n);return e?e.ri(t,n,i):""},rs:function(e,t,n){var i=e[e.length-1];if(f(i))for(
var r=0;r<i.length;r++)e.push(i[r]),n(e,t,this),e.pop();else n(e,t,this)},s:function(e,t,n,i,r,o,s){return(!f(e)||0!==e.length)&&(s=!!(e="function"==typeof e?this.ms(e,t,n,i,r,o,s):e),!i&&s&&t&&t.push("object"==typeof e?e:t[t.length-1]),s)},d:function(e,t,n,i){var r,o=e.split("."),s=this.f(o[0],t,n,i),a=this.options.modelGet,u=null;if("."===e&&f(t[t.length-2]))s=t[t.length-1];else for(var c=1;c<o.length;c++)s=void 0!==(r=l(o[c],s,a))?(u=s,r):"";return!(i&&!s)&&(i||"function"!=typeof s||(t.push(u
),s=this.mv(s,t,n),t.pop()),s)},f:function(e,t,n,i){for(var r=!1,o=!1,s=this.options.modelGet,a=t.length-1;0<=a;a--)if(void 0!==(r=l(e,t[a],s))){o=!0;break}return o?i||"function"!=typeof r?r:this.mv(r,t,n):!i&&""},ls:function(e,t,n,i,r,o){var s=this.options.delimiters;return this.options.delimiters=o,this.b(this.ct(a(e.call(t,r,n)),t,i)),this.options.delimiters=s,!1},ct:function(e,t,n){if(this.options.disableLambda)throw new Error("Lambda features disabled.");return this.c.compile(e,this.options
...
S&&n==l&&clearTimeout(p),f=e.clientX,d=e.clientY,f&&d||(t=e.targetTouches[0],f=t.clientX,d=t.clientY),c=n,y=w=!1,h=M?n.getBoundingClientRect():null,_&&(clearTimeout(v),M=!1,v=setTimeout(function(){M=!0},_)),o.onStart.call(b,e,n))}function r(e){var t,n,i,r;c&&(M?e.preventDefault():clearTimeout(m),r=e.target,n=e.clientX,i=e.clientY,r&&n&&i||(t=e.changedTouches[0],n=n||t.clientX,i=i||t.clientY,r=r||$(n,i)),M?n>h.left-E&&n<h.right+E&&i>h.top-E&&i<h.bottom+E?(y=!1,L(c,g),o.onMoveIn.call(b,e,r)):(y=!0
,x(c,g),o.onMoveOut.call(b,e,r)):!w&&10<I(i-d)&&(w=!0,x(c,g),o.onCancel.call(r,e)),o.onMove.call(b,e,r))}function s(e){var t,n;c&&(clearTimeout(m),S?(T&&!w&&L(c,g),t=c,p=setTimeout(function(){x(t,g)},S)):x(c,g),o.onEnd.call(b,e,c),n=3==e.which||2==e.button,w||y||n||o.onTap.call(b,e,c),l=c,c=null,setTimeout(function(){f=d=null},400))}function a(e){c&&(x(c,g),c=f=d=null,o.onCancel.call(b,e))}function u(e){D(e.target,i)?e.preventDefault():f&&d&&I(e.clientX-f)<25&&I(e.clientY-d)<25&&(
e.stopPropagation(),e.preventDefault())}var c,l,f,d,h,m,p,v,b=o.containerElement||k.body,w=!1,y=!1,g=o.activeClass,T=o.activeClassDelay,S=o.inactiveClassDelay,M=o.noScroll,_=o.noScrollDelay,E=o.boundMargin;return b.addEventListener(A.start,n,!1),b.addEventListener(A.move,r,!1),b.addEventListener(A.end,s,!1),b.addEventListener("touchcancel",a,!1),o.allowClick||b.addEventListener("click",u,!1),{el:b,destroy:function(){return b.removeEventListener(A.start,n,!1),b.removeEventListener(A.move,r,!1),
...
;var TWEEN=TWEEN||function(){var n=[];return{getAll:function(){return n},removeAll:function(){n=[]},add:function(e){n.push(e)},remove:function(e){e=n.indexOf(e);-1!==e&&n.splice(e,1)},update:function(e){if(0===n.length)return!1;var t=0;for(e=void 0!==e?e:window.performance.now();t<n.length;)n[t].update(e)?t++:n.splice(t,1);return!0}}}();TWEEN.Tween=function(e){var t,c=e,l={},f={},d={},h=1e3,m=0,p=!1,n=!1,v=0,b=null,w=TWEEN.Easing.Linear.None,y=TWEEN.Interpolation.Linear,g=[],T=null,S=!1,M=null,
_=null,i=null;for(t in e)l[t]=parseFloat(e[t],10);this.to=function(e,t){return void 0!==t&&(h=t),f=e,this},this.start=function(e){for(var t in TWEEN.add(this),S=!(n=!0),b=void 0!==e?e:window.performance.now(),b+=v,f){if(f[t]instanceof Array){if(0===f[t].length)continue;f[t]=[c[t]].concat(f[t])}void 0!==l[t]&&(l[t]=c[t],l[t]instanceof Array==!1&&(l[t]*=1),d[t]=l[t]||0)}return this},this.stop=function(){return n&&(TWEEN.remove(this),n=!1,null!==i&&i.call(c),this.stopChainedTweens()),this},
...
this},this.update=function(e){var t,n,i,r,o,s;if(e<b)return!0;for(t in!1===S&&(null!==T&&T.call(c),S=!0),i=w(n=1<(n=(e-b)/h)?1:n),f)void 0!==l[t]&&(r=l[t]||0,(o=f[t])instanceof Array?c[t]=y(o,i):"number"==typeof(o="string"==typeof o?o.startsWith("+")||o.startsWith("-")?r+parseFloat(o,10):parseFloat(o,10):o)&&(c[t]=r+(o-r)*i));if(null!==M&&M.call(c,i),1!==n)return!0;if(0<m){for(t in isFinite(m)&&m--,d)"string"==typeof f[t]&&(d[t]=d[t]+parseFloat(f[t],10)),p&&(s=d[t],d[t]=f[t],f[t]=s),l[t]=d[t]
;return p&&0,b=e+v,!0}null!==_&&_.call(c);for(var a=0,u=g.length;a<u;a++)g[a].start(b+h);return!1}},TWEEN.Easing={Linear:{None:function(e){return e}},Quadratic:{In:function(e){return e*e},Out:function(e){return e*(2-e)},InOut:function(e){return(e*=2)<1?.5*e*e:-.5*(--e*(e-2)-1)}},Cubic:{In:function(e){return e*e*e},Out:function(e){return--e*e*e+1},InOut:function(e){return(e*=2)<1?.5*e*e*e:.5*((e-=2)*e*e+2)}},Quartic:{In:function(e){return e*e*e*e},Out:function(e){return 1- --e*e*e*e},
...
weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},a="en",u={};u[a]=t;function c(e){return e instanceof T}function l(e,t,n){var i;return e?("string"==typeof e?(u[e]&&(i=e),t&&(u[e]=t,i=e)):(t=e.name,u[t]=e,i=t),n||(a=i),i):a}function y(e,t,n){return c(e)?e.clone():((t=t?"string"==typeof t?{format:t,pl:n}:t:{}).date=e,new T(t))}var g=e;g.l=l,g.i=c,g.w=function(e,t
...
return this.$d.getTime()},e.startOf=function(e,t){function n(e,t){return e=g.w(r.$u?Date.UTC(r.$y,t,e):new Date(r.$y,t,e),r),o?e:e.endOf(m)}function i(e,t){return g.w(r.toDate()[e].apply(r.toDate(),(o?[0,0,0,0]:[23,59,59,999]).slice(t)),r)}var r=this,o=!!g.u(t)||t,e=g.p(e),s=this.$W,a=this.$M,u=this.$D,c="set"+(this.$u?"UTC":"");switch(e){case b:return o?n(1,0):n(31,11);case v:return o?n(1,a):n(0,a+1);case p:var l=this.$locale().weekStart||0,l=(s<l?s+7:s)-l;return n(o?u-l:u+(6-l),a);case m:
...
t=e[t]||1,t=this.$d.getTime()+n*t;return g.w(t,this)},e.subtract=function(e,t){return this.add(-1*e,t)},e.format=function(e){var r=this;if(!this.isValid())return"Invalid Date";function t(e,t,n,i){return e&&(e[t]||e(r,o))||n[t].substr(0,i)}function n(e){return g.s(a%12||12,e,"0")}var o=e||"YYYY-MM-DDTHH:mm:ssZ",i=g.z(this),s=this.$locale(),a=this.$H,u=this.$m,c=this.$M,l=s.weekdays,f=s.months,e=s.meridiem||function(e,t,n){e=e<12?"AM":"PM";return n?e.toLowerCase():e},d={YY:String(this.$y).slice(-2
),YYYY:this.$y,M:c+1,MM:g.s(c+1,2,"0"),MMM:t(s.monthsShort,c,f,3),MMMM:f[c]||f(this,o),D:this.$D,DD:g.s(this.$D,2,"0"),d:String(this.$W),dd:t(s.weekdaysMin,this.$W,l,2),ddd:t(s.weekdaysShort,this.$W,l,3),dddd:l[this.$W],H:String(a),HH:g.s(a,2,"0"),h:n(1),hh:n(2),a:e(a,u,!0),A:e(a,u,!1),m:String(u),mm:g.s(u,2,"0"),s:String(this.$s),ss:g.s(this.$s,2,"0"),SSS:g.s(this.$ms,3,"0"),Z:i};return o.replace(w,function(e,t){return t||d[e]||i.replace(":","")})},e.utcOffset=function(){return 15*-Math.round(
this.$d.getTimezoneOffset()/15)},e.diff=function(e,t,n){var i=g.p(t),r=y(e),o=6e4*(r.utcOffset()-this.utcOffset()),t=this-r,e=g.m(this,r),r={};return r[b]=e/12,r[v]=e,r[s]=e/3,r[p]=(t-o)/6048e5,r.day=(t-o)/864e5,r[h]=t/36e5,r[d]=t/6e4,r[f]=t/1e3,e=r[i]||t,n?e:g.a(e)},e.daysInMonth=function(){return this.endOf(v).$D},e.$locale=function(){return u[this.$L]},e.locale=function(e,t){if(!e)return this.$L;var n=this.clone(),t=l(e,t,!0);return t&&(n.$L=t),n},e.clone=function(){return g.w(this.$d,this)},
e.toDate=function(){return new Date(this.valueOf())},e.toJSON=function(){return this.isValid()?this.toISOString():null},e.toISOString=function(){return this.$d.toISOString()},e.toString=function(){return this.$d.toUTCString()},n);function n(e){this.$L=this.$L||l(e.locale,null,!0),this.parse(e)}return y.prototype=T.prototype,y.extend=function(e,t){return e(t,T,y),y},y.locale=l,y.isDayjs=c,y.unix=function(e){return y(1e3*e)},y.en=u[a],y.Ls=u,y}),function(e){TEMPLATES={"comments-toggle":new e({
...
n=u;break}if(!n&&(e="hacker-news2",o=amplify.store(e)))for(var u,s=0,a=o.length;s<a;s++)if(t==(u=o[s]).id){n=u;break}n&&(i=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=r[e];n[e]!=t&&(n[e]=t,i=!0)}),i&&(amplify.store(e,o),(e=c("story-"+t))&&(n.selected=!!e.querySelector("a[href].selected"),n.i=e.dataset?e.dataset.index:e.getAttribute("data-index"),e.insertAdjacentHTML("afterend",y.news.markupStory(n)),e.parentNode.removeChild(e))))}},render:function(e){var t,n
,i,r,o;l||(e=e||{},t=amplify.store("hacker-news-cached"),n=g("stories-load"),i=function(e){var t=e.slice(),e=amplify.store("next"),e='<ul class="tableview tableview-links" id="hwlist">'+y.news.markupStories(t)+'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"><i class="icon-loading"></i></span></a></li></ul>';u.innerHTML=e,y.pub("onRenderNews")},t?(r=amplify.store("hacker-news"),(e=e.delay)?(l=!0,u.innerHTML=n.render({loading:!0}),setTimeout(function(){l=!1,i(r)},e)):i(r)):(
l=!0,u.innerHTML=n.render({loading:!0}),o=function(){u.innerHTML=n.render({load_error:!0}),y.pub("logAPIError","news")},hnapi.news(null,function(e){l=!1,e&&!e.error?i(e):o()},function(e){l=!1,o()})))},reload:function(){amplify.store("news-latest",null),amplify.store("next",null),y.news.render({})},more:function(n){var e;n.classList.contains("loading")||(n.classList.add("loading"),amplify.store("hacker-news2"),e=amplify.store("next"),hnapi.news(e,function(e){n.classList.remove("loading")
...
y.setTitle(n.title),S.innerHTML=n.title;var e=i.render(n,{comments_list:e}),s=w.createElement("div");s.innerHTML=e;for(var a=s.querySelectorAll("a"),u=0,c=a.length;u<c;u++)a[u].target="_blank";var l=n.user;if(l)for(var f=s.querySelectorAll(".user"),u=0,c=f.length;u<c;u++){var d=f[u];d.textContent.trim()==l&&(d.classList.add("op"),d.title="Original Poster")}if(2e4<e.length)for(var h=s.querySelectorAll(".comments>ul>li>ul"),m=g("comments-toggle"),p=0,c=h.length;p<c;p++){var v=h[p],
b=v.querySelectorAll(".metadata").length;v.style.display="none",b&&v.insertAdjacentHTML("beforebegin",m.render({comments_count:b,i_reply:1==b?"reply":"replies"}))}for(;M.hasChildNodes();)M.removeChild(M.childNodes[0]);for(;s.hasChildNodes();)M.appendChild(s.childNodes[0]);delete s,y.pub("onRenderComments")}if(e)M.scrollTop=0,n(e,t);else{var i=amplify.store("hacker-news");if(i)for(var r=0,o=i.length;r<o;r++){var s=i[r];if(t==s.id){e=s;break}}if(!e)if(i=amplify.store("hacker-news2"))for(r=0,
...
;t&&(e=t.style,t=M.scrollTop,e.display="none"==e.display?"":"none",M.scrollTop=t)},reload:function(){y.comments.currentID=null,ruto.reload()}},y.init=function(){amplify.store("next",null),y.news.render(),ruto.init(),function e(){var t,n,i,r,o,s=Array.from(document.styleSheets).find(function(e){return/hw.*\.css/i.test(e.href)});function a(e){"dark"===e?(t.media.mediaText="screen",i.content="dark"):"light"===e?(t.media.mediaText="not all",i.content="light"):(
...
){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){y.comments.render(t)})}(window),function(n){function a(e,t,n){for(var i=0;i<s;i++)r[i]||(t=t.toLowerCase()),e.addEventListener(r[i]+t,n,!1)}function u(e,t,n){for(var i=0;i<s;i++)r[i]||(t=t.toLowerCase()),e.removeEventListener(r[i]+t,n,!1)}function c(e){var t=e.in,n=e.out,i=t.classList,r=n.classList,e=e.direction,o=f[e],s=function(){r.add("hidden"),r.remove(o[0]),i.remove(o[1]),u(t,
"AnimationEnd",s)};a(t,"AnimationEnd",s),i.remove("hidden"),i.add(o[1]),r.add(o[0])}function l(e){var t,n=e.in,i=e.out,r=n.classList,o=i.classList;"up"==e.direction?(o.add("no-pointer"),r.remove("hidden"),r.add("slide-up")):(a(i,"AnimationEnd",t=function(){o.remove("slide-down"),o.add("hidden"),r.remove("no-pointer"),u(i,"AnimationEnd",t)}),o.remove("slide-up"),o.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var o=n.document,e=o.body,r=["webkit","moz",
...
):/^#\//.test(t.getAttribute("href"))?location.hash=t.hash:t.href&&d&&n.open(t.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("button.comments-toggle",function(e,t){hw.comments.toggle(t)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(e){if(d){e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),i=n.querySelectorAll(
"a[href].selected"),r=0,o=i.length;r<o;r++)i[r].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),d&&setTimeout(
function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!d,hw.init()}(window);
