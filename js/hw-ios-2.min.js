...
;e[t]=e[n],e[n]=i}}(o),o.unshift("https://api.hackerwebapp.com/");function s(e,t,n){r(o[0]+e,t,function(){m(0,e,t,n)})}var h=o.length,m=function(e,t,n,i){r(o[e]+t,n,e<h-1?function(){m(e+1,t,n,i)}:i)},p={urls:o,_news:function(e,t){s("news",e,t)},_news2:function(e,t){s("news2",e,t)},item:function(e,t,n){s("item/"+e,t,n)},comments:function(e,t,n){s("comments/"+e,t,n)}};var e=Math.floor(new Date/1e3),v=amplify.store("last_visit")||e,b=amplify.store("num_visits")||0;b++,amplify.store("last_visit",e),
amplify.store("num_visits",b);var w=Number.MAX_SAFE_INTEGER;function y(e){var t=[],n={visit_count:b,time_ago:relativeDate(1e3*v),type:"visit"};for(i=0;i<e.length;i++){v<w&&v>=e[i].date&&t.push(n),w=e[i].date;var r={id:(r=e[i]).id,title:r.link_text,url:r.link,domain:r.source,points:r.points,user:r.submitter,time_ago:relativeDate(1e3*r.date),time:r.date,comments_count:r.comments,type:"link"};r.i=p.number++,t.push(r)}return t}p.number=1,p.news=function(e,n,t){var i="news-"+(e=e||"latest"),
r="https://p.leftium.com/p?u=https://hckrnews.com/data/"+e+".js",o="latest"==e?6e4:2592e6;function s(e){var t=(next=amplify.store("next"))?dayjs(next):(lastItem=e[e.length-1],dayjs.unix(lastItem.time));t=(t=t.subtract(1,"day")).format("YYYYMMDD"),amplify.store("next",t);e=y(e);n(e)}e=amplify.store(i);e?(console.log("HIT!:  "+i),s(e)):(console.log("MISS!: "+i),p1=fetch(r),text=p1.then(function(e){p2=e.json(),p2.then(function(e){e?(amplify.store(i,e,{expires:o}),s(e)):t(null)})}))},a.hnapi=p}(
