!function(t){function e(){}function n(){var e=location.hash.slice(1),t=!1,n=f.current,e=e||c.defaultPath;n&&n!=f.previous&&(f.previous=n),f.current=e;for(var i=0,r=l.length;i<r&&!t;i++){var o=l[i],a=o.path,s=o.name,u=o.fn;"string"==typeof a?a.toLowerCase()==e.toLowerCase()&&(c.before.call(f,a,s),u.call(f),c.on.call(f,a,s),t=!0):(o=e.match(a))&&(c.before.call(f,a,s,o),u.apply(f,o),c.on.call(f,a,s,o),t=!0)}return t||c.notfound.call(f),f}var l=[],c={defaultPath:"/",before:e,on:e,notfound:e},f={
...
var i=h.type;return n&&n.type&&n.type in h.types&&(i=n.type),h.types[i](e,t,n||{})};h.types={},h.type=null,h.addType=function(i,e){h.type||(h.type=i),h.types[i]=e,h[i]=function(e,t,n){return(n=n||{}).type=i,h(e,t,n)}},h.error=function(){return"amplify.store quota exceeded"};var t,i,r,f=/^__amplify__/;function n(l,c){h.addType(l,function(t,e,n){var i,r,o,a,s=e,u=(new Date).getTime();if(!t){s={},a=[],o=0;try{for(t=c.length;t=c.key(o++);)f.test(t)&&((r=JSON.parse(c.getItem(t))
).expires&&r.expires<=u?a.push(t):s[t.replace(f,"")]=r.data);for(;t=a.pop();)c.removeItem(t)}catch(e){}return s}if(t="__amplify__"+t,e===d){if(!((r=(i=c.getItem(t))?JSON.parse(i):{expires:-1}).expires&&r.expires<=u))return r.data;c.removeItem(t)}else if(null===e)c.removeItem(t);else{r=JSON.stringify({data:e,expires:n.expires?u+n.expires:null});try{c.setItem(t,r)}catch(e){h[l]();try{c.setItem(t,r)}catch(e){throw h.error()}}}return s})}for(t in{localStorage:1,sessionStorage:1})try{
...
;try{c.addBehavior("#default#userdata"),c.load(f)}catch(e){return c.parentNode.removeChild(c)}h.addType("userData",function(t,e,n){c.load(f);var i,r,o,a,s,u=e,l=(new Date).getTime();if(!t){for(u={},s=[],a=0;i=c.XMLDocument.documentElement.attributes[a++];)(r=JSON.parse(i.value)).expires&&r.expires<=l?s.push(i.name):u[i.name]=r.data;for(;t=s.pop();)c.removeAttribute(t);return c.save(f),u}if(t=(t=t.replace(
...
){return this.r(e,t,n)},ep:function(e,t){var n=this.partials[e],i=t[n.name];if(n.instance&&n.base==i)return n.instance;if("string"==typeof i){if(!this.c)throw new Error("No compiler available.");i=this.c.compile(i,this.options)}if(!i)return null;if(this.partials[e].base=i,n.subs){for(key in t.stackText||(t.stackText={}),n.subs)t.stackText[key]||(t.stackText[key]=void 0!==this.activeSub&&t.stackText[this.activeSub]?t.stackText[this.activeSub]:this.text);i=function(e,t,n,i,r,o){function a(){}
function s(){}s.prototype=(a.prototype=e).subs;var u=new a;for(var l in u.subs=new s,u.subsText={},u.buf="",i=i||{},u.stackSubs=i,u.subsText=o,t)i[l]||(i[l]=t[l]);for(l in i)u.subs[l]=i[l];for(l in r=r||{},u.stackPartials=r,n)r[l]||(r[l]=n[l]);for(l in r)u.partials[l]=r[l];return u}(i,n.subs,n.partials,this.stackSubs,this.stackPartials,t.stackText)}return this.partials[e].instance=i},rp:function(e,t,n,i){e=this.ep(e,n);return e?e.ri(t,n,i):""},rs:function(e,t,n){var i=e[e.length-1];if(f(i))for(
var r=0;r<i.length;r++)e.push(i[r]),n(e,t,this),e.pop();else n(e,t,this)},s:function(e,t,n,i,r,o,a){return(!f(e)||0!==e.length)&&(a=!!(e="function"==typeof e?this.ms(e,t,n,i,r,o,a):e),!i&&a&&t&&t.push("object"==typeof e?e:t[t.length-1]),a)},d:function(e,t,n,i){var r,o=e.split("."),a=this.f(o[0],t,n,i),s=this.options.modelGet,u=null;if("."===e&&f(t[t.length-2]))a=t[t.length-1];else for(var l=1;l<o.length;l++)a=void 0!==(r=c(o[l],a,s))?(u=a,r):"";return!(i&&!a)&&(i||"function"!=typeof a||(t.push(u
),a=this.mv(a,t,n),t.pop()),a)},f:function(e,t,n,i){for(var r=!1,o=!1,a=this.options.modelGet,s=t.length-1;0<=s;s--)if(void 0!==(r=c(e,t[s],a))){o=!0;break}return o?i||"function"!=typeof r?r:this.mv(r,t,n):!i&&""},ls:function(e,t,n,i,r,o){var a=this.options.delimiters;return this.options.delimiters=o,this.b(this.ct(s(e.call(t,r,n)),t,i)),this.options.delimiters=a,!1},ct:function(e,t,n){if(this.options.disableLambda)throw new Error("Lambda features disabled.");return this.c.compile(e,this.options
).render(t,n)},b:function(e){this.buf+=e},fl:function(){var e=this.buf;return this.buf="",e},ms:function(e,t,n,i,r,o,a){var s=t[t.length-1],e=e.call(s);return"function"==typeof e?!!i||(i=this.activeSub&&this.subsText&&this.subsText[this.activeSub]?this.subsText[this.activeSub]:this.text,this.ls(e,s,t,n,i.substring(r,o),a)):e},mv:function(e,t,n){t=t[t.length-1],e=e.call(t);return"function"==typeof e?this.ct(s(e.call(t)),t,n):e},sub:function(e,t,n,i){var r=this.subs[e];r&&(this.activeSub=e,r(t,n,
this,i),this.activeSub=!1)}};var t=/&/g,n=/</g,i=/>/g,r=/\'/g,o=/\"/g,a=/[&<>\"\']/;function s(e){return String(null==e?"":e)}var f=Array.isArray||function(e){return"[object Array]"===Object.prototype.toString.call(e)}}("undefined"!=typeof exports?exports:Hogan),function(s){function u(){return+new Date}var l=!!s.XDomainRequest,c="withCredentials"in new XMLHttpRequest||l,f=!1,d={};try{(f=new Worker("js/hnapi-worker.js")).addEventListener("message",function(e){var t,n=e.data,i=n.url||"";d[i]&&(e=(
t=d[i]).error,t=t.success,delete d[i],n.error?e(n.error):t(n.response))},!1)}catch(e){}function r(t,e,n){var i,r,o,a;e=e||function(){},n=n||function(){},c?f?(d[t]={success:e,error:n},f.postMessage({url:t,timeout:2e4})):((i=d[t]||new(l?XDomainRequest:XMLHttpRequest))._timeout&&clearTimeout(i._timeout),i._timeout=setTimeout(function(){i.abort()},2e4),i.onload=function(){clearTimeout(this._timeout),delete d[t];try{e(JSON.parse(this.responseText))}catch(e){n(e)}},
...
;e[t]=e[n],e[n]=i}}(o),o.unshift("https://api.hackerwebapp.com/");function a(e,t,n){r(o[0]+e,t,function(){m(0,e,t,n)})}var h=o.length,m=function(e,t,n,i){r(o[e]+t,n,e<h-1?function(){m(e+1,t,n,i)}:i)},e={urls:o,_news:function(e,t){a("news",e,t)},_news2:function(e,t){a("news2",e,t)},item:function(e,t,n){a("item/"+e,t,n)},comments:function(e,t,n){a("comments/"+e,t,n)}};var t=Math.floor(new Date/1e3),p=amplify.store("last_visit")||t,v=amplify.store("num_visits")||0;v++,amplify.store("last_visit",t),
...
,x(l,g),o.onMoveOut.call(b,e,r)):!w&&10<I(i-d)&&(w=!0,x(l,g),o.onCancel.call(r,e)),o.onMove.call(b,e,r))}function a(e){var t,n;l&&(clearTimeout(m),S?(T&&!w&&L(l,g),t=l,p=setTimeout(function(){x(t,g)},S)):x(l,g),o.onEnd.call(b,e,l),n=3==e.which||2==e.button,w||y||n||o.onTap.call(b,e,l),c=l,l=null,setTimeout(function(){f=d=null},400))}function s(e){l&&(x(l,g),l=f=d=null,o.onCancel.call(b,e))}function u(e){D(e.target,i)?e.preventDefault():f&&d&&I(e.clientX-f)<25&&I(e.clientY-d)<25&&(
e.stopPropagation(),e.preventDefault())}var l,c,f,d,h,m,p,v,b=o.containerElement||k.body,w=!1,y=!1,g=o.activeClass,T=o.activeClassDelay,S=o.inactiveClassDelay,M=o.noScroll,_=o.noScrollDelay,E=o.boundMargin;return b.addEventListener(A.start,n,!1),b.addEventListener(A.move,r,!1),b.addEventListener(A.end,a,!1),b.addEventListener("touchcancel",s,!1),o.allowClick||b.addEventListener("click",u,!1),{el:b,destroy:function(){return b.removeEventListener(A.start,n,!1),b.removeEventListener(A.move,r,!1),
b.removeEventListener(A.end,a,!1),b.removeEventListener("touchcancel",s,!1),o.allowClick||b.removeEventListener("click",u,!1),this}}}}),function(){var e;"performance"in window==!1&&(window.performance={}),Date.now=Date.now||function(){return(new Date).getTime()},"now"in window.performance==!1&&(e=window.performance.timing&&window.performance.timing.navigationStart?window.performance.timing.navigationStart:Date.now(),window.performance.now=function(){return Date.now()-e})}()
...
this},this.update=function(e){var t,n,i,r,o,a;if(e<b)return!0;for(t in!1===S&&(null!==T&&T.call(l),S=!0),i=w(n=1<(n=(e-b)/h)?1:n),f)void 0!==c[t]&&(r=c[t]||0,(o=f[t])instanceof Array?l[t]=y(o,i):"number"==typeof(o="string"==typeof o?o.startsWith("+")||o.startsWith("-")?r+parseFloat(o,10):parseFloat(o,10):o)&&(l[t]=r+(o-r)*i));if(null!==M&&M.call(l,i),1!==n)return!0;if(0<m){for(t in isFinite(m)&&m--,d)"string"==typeof f[t]&&(d[t]=d[t]+parseFloat(f[t],10)),p&&(a=d[t],d[t]=f[t],f[t]=a),c[t]=d[t]
;return p&&0,b=e+v,!0}null!==_&&_.call(l);for(var s=0,u=g.length;s<u;s++)g[s].start(b+h);return!1}},TWEEN.Easing={Linear:{None:function(e){return e}},Quadratic:{In:function(e){return e*e},Out:function(e){return e*(2-e)},InOut:function(e){return(e*=2)<1?.5*e*e:-.5*(--e*(e-2)-1)}},Cubic:{In:function(e){return e*e*e},Out:function(e){return--e*e*e+1},InOut:function(e){return(e*=2)<1?.5*e*e*e:.5*((e-=2)*e*e+2)}},Quartic:{In:function(e){return e*e*e*e},Out:function(e){return 1- --e*e*e*e},
...
;return t<0?o(e[0],e[1],i):1<t?o(e[n],e[n-1],n-i):o(e[r],e[n<r+1?n:r+1],i-r)},Bezier:function(e,t){for(var n=0,i=e.length-1,r=Math.pow,o=TWEEN.Interpolation.Utils.Bernstein,a=0;a<=i;a++)n+=r(1-t,i-a)*r(t,a)*e[a]*o(i,a);return n},CatmullRom:function(e,t){var n=e.length-1,i=n*t,r=Math.floor(i),o=TWEEN.Interpolation.Utils.CatmullRom;return e[0]===e[n]?o(e[((r=t<0?Math.floor(i=n*(1+t)):r)-1+n)%n],e[r],e[(r+1)%n],e[(r+2)%n],i-r):t<0?e[0]-(o(e[0],e[0],e[1],e[1],-i)-e[0]):1<t?e[n]-(o(e[n],e[n],e[n-1],
...
window.requestAnimationFrame=function(e,t){var n=(new Date).getTime(),i=Math.max(0,16-(n-o)),r=window.setTimeout(function(){e(n+i)},i);return o=n+i,r}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}();var relativeDate=function(){var e=864e5,t=365*e,n=t/12,a=[[42e3,"just now"],[9e4,"a minute ago"],[36e5,"minutes ago",6e4],[54e5,"an hour ago"],[e,"hours ago",36e5],[2*e,"yesterday"],[7*e,"days ago",e],[9072e5,"a week ago"],[n,"weeks ago",6048e5],[3942e6,
"a month ago"],[t,"months ago",n],[1.5*t,"a year ago"],[Number.MAX_VALUE,"years ago",t]];return function(e,t){for(var n,i=(t=(t=t||(new Date).getTime())instanceof Date?t.getTime():t)-(e=e instanceof Date?e.getTime():e),r=-1,o=a.length;++r<o;)if(i<(n=a[r])[0])return null==n[2]?n[1]:Math.round(i/n[2])+" "+n[1]}}();"undefined"!=typeof module&&module.exports&&(module.exports=relativeDate),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(
):"function"==typeof define&&define.amd?define(t):e.dayjs=t()}(this,function(){"use strict";function i(e,t,n){var i=String(e);return!i||i.length>=t?e:""+Array(t+1-i.length).join(n)+e}var r="millisecond",f="second",d="minute",h="hour",m="day",p="week",v="month",a="quarter",b="year",o=/^(\d{4})-?(\d{1,2})-?(\d{0,2})[^0-9]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?.?(\d{1,3})?$/,w=/\[([^\]]+)]|Y{2,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,e={s:i,z:function(e){var t=-e.utcOffset()
...
weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},s="en",u={};u[s]=t;function l(e){return e instanceof T}function c(e,t,n){var i;return e?("string"==typeof e?(u[e]&&(i=e),t&&(u[e]=t,i=e)):(t=e.name,u[t]=e,i=t),n||(s=i),i):s}function y(e,t,n){return l(e)?e.clone():((t=t?"string"==typeof t?{format:t,pl:n}:t:{}).date=e,new T(t))}var g=e;g.l=c,g.i=l,g.w=function(e,t
...
return this.$d.getTime()},e.startOf=function(e,t){function n(e,t){return e=g.w(r.$u?Date.UTC(r.$y,t,e):new Date(r.$y,t,e),r),o?e:e.endOf(m)}function i(e,t){return g.w(r.toDate()[e].apply(r.toDate(),(o?[0,0,0,0]:[23,59,59,999]).slice(t)),r)}var r=this,o=!!g.u(t)||t,e=g.p(e),a=this.$W,s=this.$M,u=this.$D,l="set"+(this.$u?"UTC":"");switch(e){case b:return o?n(1,0):n(31,11);case v:return o?n(1,s):n(0,s+1);case p:var c=this.$locale().weekStart||0,c=(a<c?a+7:a)-c;return n(o?u-c:u+(6-c),s);case m:
...
i.f("i_visit",e,t,0))),i.b(" total            </span>        </div>    </a></li>"),i.fl()},partials:{},subs:{}})}}(Hogan.Template),function(e){var w=e.document,l=e.$=function(e){return w.getElementById(e)},o={},y={pub:function(e,t){var n=o[e];if(n)for(var i=0,r=n.length;i<r;i++)n[i].call(this,t)},sub:function(e,t){o[e]||(o[e]=[]),o[e].push(t)},currentView:null,hideAllViews:function(){for(var e=w.querySelectorAll(".view"),t=0,n=e.length;t<n;t++)e[t].classList.add("hidden")},tmpl:function(e,t){
e=TEMPLATES[e];if(e)return t?e.render(t):e},setTitle:function(e){var t="HckrWeb";e&&(e=e.replace(/^\s+|\s+$/g,"")).toLowerCase()!=t.toLowerCase()&&(t=e+" – "+t),document.title=t}};"undefined"!=typeof ga&&y.sub("logAPIError",function(e){ga("send","event","Errors","API",e)});var g=y.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);function T(e){var t=s[e];if(t)return t;a.href=e;var n=a.hostname.replace(/^www\./,
""),i=(r=a.pathname.replace(/^\//,"").split("/")[0]).length,r=n.length<=25&&3<i&&i<=15&&/^[^0-9][^.]+$/.test(r)?"/"+r:"";return s[e]=t=n+r}var a=w.createElement("a"),s={},u=w.querySelector("#view-home .scroll").querySelector("section"),c=!1;y.news={options:{disclosure:!0},markupStory:function(e){return/^item/i.test(e.url)?e.url="#/item/"+e.id:(e.external=!0,e.domain=T(e.url)),y.news.options.disclosure?("link"==e.type&&(e.detail_disclosure=!0),/^#\//.test(e.url)&&(e.detail_disclosure=!1,
e.disclosure=!0,e.domain=null)):e.id&&(e.url="#/item/"+e.id),e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments","visit"==e.type?(e.i_visit=1==e.visit_count?"refresh":"refreshes",g("visit",e)):g("post",e)},markupStories:function(e,t){var n="";var i=y.news.markupStory;return e.forEach(function(e){n+=i(e)}),n},updateStory:function(e){if(e&&e.id){var n,i,t=e.id,r=e.data,e="hacker-news",o=amplify.store(e);if(o)for(var a=0,s=o.length;a<s;a++)if(t==(u=o[a]).id){
n=u;break}if(!n&&(e="hacker-news2",o=amplify.store(e)))for(var u,a=0,s=o.length;a<s;a++)if(t==(u=o[a]).id){n=u;break}n&&(i=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=r[e];n[e]!=t&&(n[e]=t,i=!0)}),i&&(amplify.store(e,o),(e=l("story-"+t))&&(n.selected=!!e.querySelector("a[href].selected"),n.i=e.dataset?e.dataset.index:e.getAttribute("data-index"),e.insertAdjacentHTML("afterend",y.news.markupStory(n)),e.parentNode.removeChild(e))))}},render:function(e){var t,n
,i,r,o;c||(e=e||{},t=amplify.store("hacker-news-cached"),n=g("stories-load"),i=function(e){var t=e.slice(),e=amplify.store("next"),e='<ul class="tableview tableview-links" id="hwlist">'+y.news.markupStories(t)+'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"><i class="icon-loading"></i></span></a></li></ul>';u.innerHTML=e,y.pub("onRenderNews")},t?(r=amplify.store("hacker-news"),(e=e.delay)?(c=!0,u.innerHTML=n.render({loading:!0}),setTimeout(function(){c=!1,i(r)},e)):i(r)):(
c=!0,u.innerHTML=n.render({loading:!0}),o=function(){u.innerHTML=n.render({load_error:!0}),y.pub("logAPIError","news")},hnapi.news(null,function(e){c=!1,e&&!e.error?i(e):o()},function(e){c=!1,o()})))},reload:function(){amplify.store("news-latest",null),amplify.store("next",null),y.news.render({})},more:function(n){var e;n.classList.contains("loading")||(n.classList.add("loading"),amplify.store("hacker-news2"),e=amplify.store("next"),hnapi.news(e,function(e){n.classList.remove("loading")
;var t=n.parentNode;t&&(t.parentNode&&t.parentNode.removeChild(t),e&&(e=e.slice(),e=y.news.markupStories(e),l("hwlist").insertAdjacentHTML("beforeend",e),e=amplify.store("next"),l("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"></span></a></li>')))}))}};var t=l("view-comments"),S=t.querySelector("header h1"),M=t.querySelector("section");y.comments={currentID:null,render:function(t){if(t){var e=amplify.store.sessionStorage(
...
y.setTitle(n.title),S.innerHTML=n.title;var e=i.render(n,{comments_list:e}),a=w.createElement("div");a.innerHTML=e;for(var s=a.querySelectorAll("a"),u=0,l=s.length;u<l;u++)s[u].target="_blank";var c=n.user;if(c)for(var f=a.querySelectorAll(".user"),u=0,l=f.length;u<l;u++){var d=f[u];d.textContent.trim()==c&&(d.classList.add("op"),d.title="Original Poster")}if(2e4<e.length)for(var h=a.querySelectorAll(".comments>ul>li>ul"),m=g("comments-toggle"),p=0,l=h.length;p<l;p++){var v=h[p],
b=v.querySelectorAll(".metadata").length;v.style.display="none",b&&v.insertAdjacentHTML("beforebegin",m.render({comments_count:b,i_reply:1==b?"reply":"replies"}))}for(;M.hasChildNodes();)M.removeChild(M.childNodes[0]);for(;a.hasChildNodes();)M.appendChild(a.childNodes[0]);delete a,y.pub("onRenderComments")}if(e)M.scrollTop=0,n(e,t);else{var i=amplify.store("hacker-news");if(i)for(var r=0,o=i.length;r<o;r++){var a=i[r];if(t==a.id){e=a;break}}if(!e)if(i=amplify.store("hacker-news2"))for(r=0,
o=i.length;r<o;r++){a=i[r];if(t==a.id){e=a;break}}e?(e.loading=!0,n(e,t)):n({loading:!0},t);function s(){e?(delete e.loading,e.load_error=!0,n(e,t)):n({load_error:!0},t),y.pub("logAPIError","comments")}hnapi.item(t,function(e){y.comments.currentID==t&&(!e||e.error&&"comments"==y.currentView?s():(amplify.store.sessionStorage("hacker-item-"+t,e,{expires:3e5}),y.news.updateStory({id:t,data:e}),n(e,t)))},function(e){y.comments.currentID==t&&s()})}}}},toggle:function(e){var t=e.nextElementSibling
;t&&(e=t.style,t=M.scrollTop,e.display="none"==e.display?"":"none",M.scrollTop=t)},reload:function(){y.comments.currentID=null,ruto.reload()}},y.init=function(){amplify.store("next",null),y.news.render(),ruto.init(),function e(){var t,n,i,r,o,a=Array.from(document.styleSheets).find(function(e){return/hw.*\.css/i.test(e.href)});function s(e){"dark"===e?(t.media.mediaText="screen",i.content="dark"):"light"===e?(t.media.mediaText="not all",i.content="light"):(
t.media.mediaText="(prefers-color-scheme: dark)",i.content="dark light")}a?(t=Array.from(a.cssRules).find(function(e){return e.media&&/color-scheme:\s*dark/i.test(e.media.mediaText)}))&&(l("hw-appearance-container").hidden=!1,n=l("hw-appearance"),i=l("meta-color-scheme"),r=window.matchMedia&&"not all"!==window.matchMedia("(prefers-color-scheme)").media,o="hw-appearance",s(a=localStorage.getItem(o)||"auto"),r?(n.querySelector("[name=hw-appearance][value=auto]").parentNode.hidden=!1,
n.querySelector("[name=hw-appearance][value="+a+"]").checked=!0):(/(light|dark)/i.test(a)||(a="light"),n.querySelector('[name=hw-appearance][value="'+a+'"]').checked=!0),n.onclick=function(){var e=n.querySelector("[name=hw-appearance]:checked").value;localStorage.setItem(o,e),s(e)}):setTimeout(e,1e3)}()},e.hw=y,ruto.config({before:function(e,t){y.hideAllViews();var n=l("view-"+t);n.classList.remove("hidden"),y.currentView=t,y.setTitle(n.querySelector("header h1").textContent)},notfound:function(
){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){y.comments.render(t)})}(window),function(n){function s(e,t,n){for(var i=0;i<a;i++)r[i]||(t=t.toLowerCase()),e.addEventListener(r[i]+t,n,!1)}function u(e,t,n){for(var i=0;i<a;i++)r[i]||(t=t.toLowerCase()),e.removeEventListener(r[i]+t,n,!1)}function l(e){var t=e.in,n=e.out,i=t.classList,r=n.classList,e=e.direction,o=f[e],a=function(){r.add("hidden"),r.remove(o[0]),i.remove(o[1]),u(t,
"AnimationEnd",a)};s(t,"AnimationEnd",a),i.remove("hidden"),i.add(o[1]),r.add(o[0])}function c(e){var t,n=e.in,i=e.out,r=n.classList,o=i.classList;"up"==e.direction?(o.add("no-pointer"),r.remove("hidden"),r.add("slide-up")):(s(i,"AnimationEnd",t=function(){o.remove("slide-down"),o.add("hidden"),r.remove("no-pointer"),u(i,"AnimationEnd",t)}),o.remove("slide-up"),o.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var o=n.document,e=o.body,r=["webkit","moz",
"MS","o",""],a=r.length,f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},i=o.querySelector("meta[name=viewport]");i||((i=o.createElement("meta")).name="viewport",o.head.appendChild(i)),i.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var d="wide"==t();n.addEventListener("resize",function(){var e="wide"==t();e!=d&&(d=e,location.reload())}),d&&e.insertAdjacentHTML("beforeend",
'<div id="overlay" class="hide"></div>');var h=!1;document.addEventListener("touchstart",function(e){e=e.targetTouches[0].clientX;(e<20||e>window.innerWidth-20)&&(h=!0)}),document.addEventListener("touchend",function(e){h=!1}),ruto.config({before:function(e,t,n){var i,r=hw.previousView=hw.currentView,t=hw.currentView=t,o=hw.hideAllViews,a=$("view-"+t);switch(hw.setTitle(a.querySelector("header h1").textContent),t){case"home":d?(o(),$("overlay").classList.add("hide"),a.classList.remove("hidden"),
(i=$("view-comments")).classList.remove("hidden"),i.querySelector("section").innerHTML='<div class="view-blank-state"><div class="view-blank-state-text">No Story Selected.</div></div>',i.querySelector("header h1").innerHTML="",i.querySelector("header a.header-back-button").style.display="none",hw.comments.currentID=null,hw.pub("selectCurrentStory")):"comments"!=r||h?"about"!=r||h?(o(),a.classList.remove("hidden")):c({in:a,out:$("view-"+r),direction:"down"}):l({in:a,out:$("view-"+r),
direction:"ltr"});break;case"about":d?(a.classList.remove("hidden"),$("view-home").classList.remove("hidden"),$("view-comments").classList.remove("hidden"),setTimeout(function(){$("overlay").classList.remove("hide")},1)):"home"!=r||h?(o(),$("view-home").classList.remove("hidden"),a.classList.remove("hidden")):c({in:a,out:$("view-"+r),direction:"up"}),"undefined"!=typeof ga&&ga("send","pageview",e);break;case"comments":d?(o(),$("overlay").classList.add("hide"),a.classList.remove("hidden"),$(
"view-home").classList.remove("hidden"),hw.pub("selectCurrentStory",n[1]),a.querySelector("header a.header-back-button").style.display=""):"home"!=r||h?(o(),a.classList.remove("hidden")):((i=n[1])&&hw.comments.currentID!=i&&(a.querySelector("section").scrollTop=0),l({in:a,out:$("view-"+r),direction:"rtl"}))}}}),n.addEventListener("pagehide",function(){for(var e=o.querySelectorAll(".view"),t={},n=0,i=e.length;n<i;n++){var r=e[n];t[r.id]=r.querySelector(".scroll section").scrollTop||0}
amplify.store("hacker-scrolltops",t)},!1);i=function(){var e,t=amplify.store("hacker-scrolltops");for(e in t)$(e).querySelector(".scroll section").scrollTop=t[e]};n.addEventListener("pageshow",i,!1),i(),tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(e,t){t=t.hash;d&&/about/i.test(ruto.current)&&"#/"==t?ruto.back("/"):location.hash=t}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var m,p=!1;tappable(".view>header h1",{onTap:function(e,t){var i,
r=t.parentNode.nextElementSibling.firstElementChild;0==r.scrollTop||p||p||(p=!0,i=r.style.overflow,r.style.overflow="hidden",setTimeout(function(){r.style.overflow=i;var e=new TWEEN.Tween({scrollTop:r.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){r.scrollTop=this.scrollTop}).onComplete(function(){cancelAnimationFrame(n),e.stop(),p=!1,delete e}).start(),t=function(){TWEEN.update(),requestAnimationFrame(t)},n=requestAnimationFrame(t)},200))}}),tappable(
...
):/^#\//.test(t.getAttribute("href"))?location.hash=t.hash:t.href&&d&&n.open(t.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure",{noScroll:!0,noScrollDelay:100,onTap:function(e,t){"comments"!=hw.currentView&&(location.hash=t.hash)}}),tappable("button.comments-toggle",function(e,t){hw.comments.toggle(t)}),tappable("#view-comments .load-error button",
hw.comments.reload),hw.sub("selectCurrentStory",function(e){if(d){e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),i=n.querySelectorAll("a[href].selected"),r=0,o=i.length;r<o;r++)i[r].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),
d&&setTimeout(function(){$("view-about").classList.add("animated")},400);var v=o.head||o.getElementsByTagName("head")[0],i=function(){var e=n.innerHeight,t=$("view-height");t||((t=o.createElement("style")).id="view-height",v.appendChild(t)),788<=n.innerWidth&&(e*=.9),t.textContent=".view>.scroll{min-height: "+e+"px}"};n.addEventListener("resize",i,!1),n.addEventListener("orientationchange",i,!1),i(),hw.news.options.disclosure=!d,hw.init()}(window);
