...
this.ls(j,i,b,c,h.substring(e,f),g)):j},mv:function(a,b,c){var e=b[b.length-1],f=a.call(e);return"function"==typeof f?this.ct(d(f.call(e)),e,c):f},sub:function(a,b,c,d){var e=this.subs[a];e&&(this.activeSub=a,e(b,c,this,d),this.activeSub=!1)}};var f=/&/g,g=/</g,h=/>/g,i=/\'/g,j=/\"/g,k=/[&<>\"\']/,l=Array.isArray||function(a){return"[object Array]"===Object.prototype.toString.call(a)}}("undefined"!=typeof exports?exports:Hogan),function(a){function b(a,b){var c=document.createElement("script");c.src=a;
var d=document.getElementsByTagName("head")[0],e=!1;c.onload=c.onreadystatechange=function(){e||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(e=!0,b(),c.onload=c.onreadystatechange=null,d.removeChild(c))},d.appendChild(c)}function c(a){return{id:a.id,title:a.link_text,url:a.link,domain:a.source,points:a.points,user:a.submitter,time_ago:relativeDate(1e3*a.date),comments_count:a.comments,type:"link"}}function d(a){r=[],s=[];var b=Math.floor(new Date/1e3),d=amplify.store("last_visit")||b,e=amplify.store("num_visits")||0;
e++,amplify.store("last_visit",b),amplify.store("num_visits",e);for(var f=0;f<a.length&&a[f].date>d;){var g=c(a[f]);f++,g.i=f,r.push(g)}for(r.push({visit_count:e,time_ago:relativeDate(1e3*d),type:"visit"});f<a.length;){var g=c(a[f]);f++,g.i=f,s.push(g)}}var e=function(){return+new Date},f=!!a.XDomainRequest,g="withCredentials"in new XMLHttpRequest||f,h=!1,i=2e4,j={};try{h=new Worker("js/hnapi-worker.js"),h.addEventListener("message",function(a){var b=a.data,c=b.url||"";if(j[c]){var d=j[c],e=d.error,f=d.success;
delete j[c],b.error?e(b.error):f(b.response)}},!1)}catch(a){}var k=function(b,c,d){if(c||(c=function(){}),d||(d=function(){}),g)if(h)j[b]={success:c,error:d},h.postMessage({url:b,timeout:i});else{var k=j[b]||(f?new XDomainRequest:new XMLHttpRequest);k._timeout&&clearTimeout(k._timeout),k._timeout=setTimeout(function(){k.abort()},i),k.onload=function(){clearTimeout(this._timeout),delete j[b];try{c(JSON.parse(this.responseText))}catch(a){d(a)}},k.onerror=k.onabort=k.ontimeout=function(a){clearTimeout(this._timeout),
delete j[b],d(a)},(k.readyState<=1||f)&&(k.open("GET",b+"?"+e(),!0),k.send()),j[b]=k}else{var l=a.document,m=l.createElement("script"),n="callback"+e();a[n]=c,m.onerror=d,m.src=b+"?callback="+n,l.body.appendChild(m)}},l=["https://node-hnapi-eu.herokuapp.com/","https://node-hnapi.azurewebsites.net/","https://node-hnapi-eus.azurewebsites.net/"],m=function(a){for(var b=a.length-1;b>0;b--){var c=Math.floor(Math.random()*(b+1)),d=a[b];a[b]=a[c],a[c]=d}};m(l),l.unshift("https://api.hackerwebapp.com/");var n=l.length,o=function(a,b,c,d){
var e=a<n-1?function(){o(a+1,b,c,d)}:d;k(l[a]+b,c,e)},p=function(a,b,c){k(l[0]+a,b,function(){o(0,a,b,c)})},q={urls:l,_news:function(a,b){p("news",a,b)},_news2:function(a,b){p("news2",a,b)},item:function(a,b,c){p("item/"+a,b,c)},comments:function(a,b,c){p("comments/"+a,b,c)}},r=[],s=[];q.news=function(a){entries=null,b("//hckrnews.com/data/latest.js?"+e(),function(){entries?(d(entries),a(r)):a(null)})},q.news2=function(a){a(entries?s:null)},a.hnapi=q}(window),function(a,b){"function"==typeof define&&define.amd?define("tappable",[],function(){
...
}var c=1e3,d=60*c,e=60*d,f=24*e,g=7*f,h=365*f,i=h/12,j=[[.7*d,"just now"],[1.5*d,"a minute ago"],[60*d,"minutes ago",d],[1.5*e,"an hour ago"],[f,"hours ago",e],[2*f,"yesterday"],[7*f,"days ago",f],[1.5*g,"a week ago"],[i,"weeks ago",g],[1.5*i,"a month ago"],[h,"months ago",i],[1.5*h,"a year ago"],[Number.MAX_VALUE,"years ago",h]];return b}();"undefined"!=typeof module&&module.exports&&(module.exports=relativeDate),function(a){TEMPLATES={"comments-toggle":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),
d.b('<button class="comments-toggle">'),d.b(d.v(d.f("comments_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_reply",a,b,0))),d.b("</button>"),d.fl()},partials:{},subs:{}}),comments:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("comments",a,b,1),a,b,0,13,418,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<li><p class="metadata '),c.s(c.f("deleted",a,b,1),a,b,0,48,55,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b("deleted")}),a.pop()),c.b('">'),c.s(c.f("deleted",a,b,1),a,b,0,81,103,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b("<span>[deleted]</span>")}),a.pop()),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b('<a href="https://news.ycombinator.com/user?id='),c.b(c.v(c.f("user",a,b,0))),c.b('" target="_blank"><b class="user">'),c.b(c.v(c.f("user",a,b,0))),c.b("</b></a>")),c.b('<time><a href="https://news.ycombinator.com/item?id='),c.b(c.v(c.f("id",a,b,0))),c.b('" target="_blank">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</a></time></p>"),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b("<p>"),c.b(c.t(c.f("content",a,b,0))),
c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")),c.b("</li>")}),a.pop()),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),"post-comments":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<div class="post-content">'),d.s(d.f("has_post",a,b,1),a,b,0,39,573,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<header><a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" target="_blank"><h1>'),c.b(c.v(c.f("title",a,b,0))),c.b("</h1>"),c.s(c.f("user",a,b,1),a,b,0,108,171,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.s(c.f("domain",a,b,1),a,b,0,119,160,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop())}),a.pop()),c.b('</a><p class="metadata">'),c.s(c.f("user",a,b,1),a,b,0,213,408,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,340,382,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span>")}),a.pop()),c.s(c.f("user",a,b,1),a,b,1,0,0,"")||(c.b('<span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</span>")),c.b('<a href="'),c.b(c.v(c.f("hn_url",a,b,0))),c.b('" target="_blank" class="external-link">'),c.b(c.v(c.f("short_hn_url",a,b,0))),c.b("</a></p></header>")}),a.pop()),d.s(d.f("has_content",a,b,1),a,b,0,602,925,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b('<section class="grouped-tableview">'),c.b(c.t(c.f("content",a,b,0))),c.s(c.f("has_poll",a,b,1),a,b,0,663,902,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<ul class="poll">'),c.s(c.f("poll",a,b,1),a,b,0,689,888,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<li title="'),c.b(c.v(c.f("percentage",a,b,0))),c.b('%"><span class="poll-details"><b>'),c.b(c.v(c.f("item",a,b,0))),c.b('</b> <span class="points">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b('</span></span><div class="poll-bar"><span style="width: '),
c.b(c.v(c.f("width",a,b,0))),c.b('"></span></div></li>')}),a.pop()),c.b("</ul>")}),a.pop()),c.b("</section>")}),a.pop()),d.b('</div><section class="comments">'),d.s(d.f("loading",a,b,1),a,b,0,985,1055,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,1082,1165,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load comments.<br><button>Try again</button></div>')}),a.pop()),
d.s(d.f("loading",a,b,1),a,b,1,0,0,"")||d.s(d.f("load_error",a,b,1),a,b,1,0,0,"")||(d.s(d.f("has_comments",a,b,1),a,b,0,1224,1251,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")}),a.pop()),d.s(d.f("has_comments",a,b,1),a,b,1,0,0,"")||d.b('<p class="no-comments">No comments.</p>')),d.b("</section>"),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),post:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),
d.b('<li id="story-'),d.b(d.v(d.f("id",a,b,0))),d.b('" data-index="'),d.b(d.v(d.f("i",a,b,0))),d.b('" class="post-'),d.b(d.v(d.f("type",a,b,0))),d.b('"><a href="#/item/'),d.b(d.v(d.f("id",a,b,0))),d.b('" class="'),d.s(d.f("detail_disclosure",a,b,1),a,b,0,116,133,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,170,180,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,209,217,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,307,591,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,340,379,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<div class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</div>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),
c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,517,559,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></div>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<div class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,642,687,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),
c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></div>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,791,859,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>')}),a.pop()),d.fl()},partials:{},subs:{}}),visit:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<li>    <a>        <div class="number"></div>        <div class="story">            <b>Last refreshed: '),d.b(d.v(d.f("time_ago",a,b,0))),d.b('</b>            <span class="metadata">                '),
d.b(d.v(d.f("visit_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_visit",a,b,0))),d.b(" total            </span>        </div>    </a></li>"),d.fl()},partials:{},subs:{}})}}(Hogan.Template),function(a){var b=a.document,c=a.$=function(a){return b.getElementById(a)},d={},e=function(a){var b={};for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},f={pub:function(a,b){var c=d[a];if(c)for(var e=0,f=c.length;e<f;e++)c[e].call(this,b)},sub:function(a,b){d[a]||(d[a]=[]),d[a].push(b)},currentView:null,hideAllViews:function(){
for(var a=b.querySelectorAll(".view"),c=0,d=a.length;c<d;c++)a[c].classList.add("hidden")},tmpl:function(a,b){var c=TEMPLATES[a];if(c)return b?c.render(b):c},setTitle:function(a){var b="HackerWeb";a&&(a=a.replace(/^\s+|\s+$/g,""),a.toLowerCase()!=b.toLowerCase()&&(b=a+" – "+b)),document.title=b}};"undefined"!=typeof ga&&f.sub("logAPIError",function(a){ga("send","event","Errors","API",a)});var g=f.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);
var h=b.createElement("a"),i={},j=function(a){var b=i[a];if(b)return b;h.href=a;var c=h.hostname.replace(/^www\./,""),d=h.pathname.replace(/^\//,"").split("/")[0],e=d.length,f=c.length<=25&&e>3&&e<=15&&/^[^0-9][^.]+$/.test(d)?"/"+d:"";return b=c+f,i[a]=b,b},k=b.querySelector("#view-home .scroll"),l=k.querySelector("section"),m=!1;f.news={options:{disclosure:!0},markupStory:function(a){return/^item/i.test(a.url)?a.url="#/item/"+a.id:(a.external=!0,a.domain=j(a.url)),f.news.options.disclosure?("link"==a.type&&(a.detail_disclosure=!0),
/^#\//.test(a.url)&&(a.detail_disclosure=!1,a.disclosure=!0,a.domain=null)):a.id&&(a.url="#/item/"+a.id),a.i_point=1==a.points?"point":"points",a.i_comment=1==a.comments_count?"comment":"comments","visit"==a.type?(a.i_visit=1==a.visit_count?"refresh":"refreshes",g("visit",a)):g("post",a)},markupStories:function(a,b){var c="";b||(b=1);var d=f.news.markupStory;return a.forEach(function(a){c+=d(a)}),c},updateStory:function(a){if(a&&a.id){var b,d=a.id,e=a.data,g="hacker-news",h=amplify.store(g);if(h)for(var i=0,j=h.length;i<j;i++){
var k=h[i];if(d==k.id){b=k;break}}if(!b&&(g="hacker-news2",h=amplify.store(g)))for(var i=0,j=h.length;i<j;i++){var k=h[i];if(d==k.id){b=k;break}}if(b){var l=!1;if(["title","url","time_ago","comments_count","points"].forEach(function(a){var c=e[a];b[a]!=c&&(b[a]=c,l=!0)}),l){amplify.store(g,h);var m=c("story-"+d);m&&(b.selected=!!m.querySelector("a[href].selected"),b.i=m.dataset?m.dataset.index:m.getAttribute("data-index"),m.insertAdjacentHTML("afterend",f.news.markupStory(b)),m.parentNode.removeChild(m));
}}}},render:function(a){if(!m){a||(a={});var b=amplify.store("hacker-news-cached"),d=g("stories-load"),e=function(a){var b=a.slice(),c='<ul class="tableview tableview-links" id="hwlist">'+f.news.markupStories(b)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";l.innerHTML=c,f.pub("onRenderNews")};if(b){var h=amplify.store("hacker-news"),i=a.delay;i?(m=!0,l.innerHTML=d.render({loading:!0}),setTimeout(function(){
m=!1,e(h)},i)):e(h)}else{m=!0,l.innerHTML=d.render({loading:!0});var j=function(){l.innerHTML=d.render({load_error:!0}),f.pub("logAPIError","news")};hnapi.news(function(a){return m=!1,!a||a.error?void j():(amplify.store("hacker-news",a),amplify.store("hacker-news-cached",!0,{expires:6e5}),amplify.store("hacker-news2",null),e(a),void hnapi.news2(function(a){a&&!a.error&&(amplify.store("hacker-news2",a),c("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'));
}))},function(a){m=!1,j()})}}},reload:function(){amplify.store("hacker-news-cached",null),f.news.render({})},more:function(a){if(!a.classList.contains("loading")){a.classList.add("loading");var b=amplify.store("hacker-news2");setTimeout(function(){a.classList.remove("loading");var d=a.parentNode;if(d&&(d.parentNode&&d.parentNode.removeChild(d),b)){var e=b.slice(),g=f.news.markupStories(e,31);c("hwlist").insertAdjacentHTML("beforeend",g)}},400)}}};var n=c("view-comments"),o=n.querySelector("header h1"),p=n.querySelector("section");
...
tappable("#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,onTap:function(a,b){location.hash=b.hash}}),tappable("button.comments-toggle",function(a,b){hw.comments.toggle(b)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;d<e;d++)c[d].classList.remove("selected");
if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()},1))}}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1);var s=function(){var a=b.querySelector("#view-comments section");if(a){var c=a.querySelector(".post-content"),d=a.querySelector(".comments");
if(d){var e=a.offsetHeight-c.offsetHeight+1,f=$("comment-section-style");f||(f=b.createElement("style"),f.id="comment-section-style",b.head.appendChild(f)),f.textContent=".view section.comments{min-height: "+e+"px;}"}}};hw.sub("onRenderComments",function(){setTimeout(s,m?1:360)}),a.addEventListener("resize",s,!1),a.addEventListener("orientationchange",s,!1);var t="undefined"!=typeof a.orientation,u=function(){t&&(c.style.height=screen.height+"px",setTimeout(function(){a.scrollTo(0,0),c.style.height=a.innerHeight+"px";
},1))};if(m){var v=$("apploader");v.parentNode.removeChild(v)}else"complete"==b.readyState?u():a.addEventListener("load",u,!1),t&&(a.onorientationchange=u),setTimeout(function(){var a=$("apploader");a&&(a.classList.add("hide"),a.addEventListener("webkitTransitionEnd",function(){a.parentNode.removeChild(a)},!1))},200);hw.news.options.disclosure=!m,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",
