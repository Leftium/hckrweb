...
var b=a.document,c=b.body,d={clockwise:["flip-out-to-left","flip-in-from-left"],anticlockwise:["flip-out-to-right","flip-in-from-right"]},e=function(a){var b=a.in,e=a.out,f=b.classList,g=e.classList,h=a.direction,i=a.fn,j=d[h],k=function(){b.removeEventListener("webkitAnimationEnd",k,!1),c.classList.remove("viewport-flip"),g.add("hidden"),f.remove("flip"),g.remove("flip"),g.remove(j[0]),f.remove(j[1]),i&&i.apply()};c.classList.add("viewport-flip"),f.remove("hidden"),g.add("flip"),f.add("flip"),b.addEventListener("webkitAnimationEnd",k,!1),
g.add(j[0]),f.add(j[1])},f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},g=function(a){var b=a.in,c=a.out,d=b.classList,e=c.classList,g=b.getElementsByTagName("header")[0],h=c.getElementsByTagName("header")[0],i=g.classList,j=h.classList,k=a.direction,l=a.fn,m=f[k],n=function(){e.add("hidden"),b.removeEventListener("webkitAnimationEnd",n,!1),e.remove("sliding"),d.remove("sliding"),e.remove(m[0]),d.remove(m[1]),i.remove("transparent"),j.remove("transparent"),
l&&l.apply()};d.remove("hidden"),e.add("sliding"),d.add("sliding"),b.addEventListener("webkitAnimationEnd",n,!1),i.add("transparent"),j.add("transparent"),e.add(m[0]),d.add(m[1])},h=function(){return a.innerWidth>=640?"wide":"narrow"},i=b.querySelector("meta[name=viewport]");i||(i=b.createElement("meta"),i.name="viewport",b.head.appendChild(i)),i.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var j=navigator.userAgent,k=j&&/iPhone|iPod/.test(j),l=parseInt((j.match(/ OS (\d+)_/i)||[,0])[1],10)<6;
