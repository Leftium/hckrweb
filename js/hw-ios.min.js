...
amplify.store("num_visits",v);var b=Number.MAX_SAFE_INTEGER,w=1;function y(e){var t=[],n={visit_count:v,time_ago:relativeDate(1e3*p),type:"visit"};for(i=0;i<e.length;i++){p<b&&p>=e[i].date&&t.push(n),b=e[i].date;var r={id:(r=e[i]).id,title:r.link_text,url:r.link,domain:r.source,points:r.points,user:r.submitter,time_ago:relativeDate(1e3*r.date),time:r.date,comments_count:r.comments,type:"link"};r.i=w++,t.push(r)}return t}e.news=function(e,n,t){var i="news-"+(e=e||"latest"),
r="https://p.leftium.com/p?u=https://hckrnews.com/data/"+e+".js",o="latest"==e?6e4:2592e6;function s(e){var t=(next=amplify.store("next"))?dayjs(next):(lastItem=e[e.length-1],dayjs.unix(lastItem.time));t=(t=t.subtract(1,"day")).format("YYYYMMDD"),amplify.store("next",t);e=y(e);n(e)}e=amplify.store(i);e?(console.log("HIT!:  "+i),s(e)):(console.log("MISS!: "+i),p1=fetch(r),text=p1.then(function(e){p2=e.json(),p2.then(function(e){e?(amplify.store(i,e,{expires:o}),s(e)):t(null)})}))},a.hnapi=e}(
...
updateStory:function(e){if(e&&e.id){var n,i,t=e.id,r=e.data,e="hacker-news",o=amplify.store(e);if(o)for(var s=0,a=o.length;s<a;s++)if(t==(l=o[s]).id){n=l;break}if(!n&&(e="hacker-news2",o=amplify.store(e)))for(var l,s=0,a=o.length;s<a;s++)if(t==(l=o[s]).id){n=l;break}n&&(i=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=r[e];n[e]!=t&&(n[e]=t,i=!0)}),i&&(amplify.store(e,o),(e=c("story-"+t))&&(n.selected=!!e.querySelector("a[href].selected"),
n.i=e.dataset?e.dataset.index:e.getAttribute("data-index"),e.insertAdjacentHTML("afterend",y.news.markupStory(n)),e.parentNode.removeChild(e))))}},render:function(e){var t,n,i,r,o;u||(e=e||{},t=amplify.store("hacker-news-cached"),n=g("stories-load"),i=function(e){var t=e.slice(),e=amplify.store("next"),e='<ul class="tableview tableview-links" id="hwlist">'+y.news.markupStories(t
)+'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"><i class="icon-loading"></i></span></a></li></ul>';l.innerHTML=e,y.pub("onRenderNews")},t?(r=amplify.store("hacker-news"),(e=e.delay)?(u=!0,l.innerHTML=n.render({loading:!0}),setTimeout(function(){u=!1,i(r)},e)):i(r)):(u=!0,l.innerHTML=n.render({loading:!0}),o=function(){l.innerHTML=n.render({load_error:!0}),y.pub("logAPIError","news")},hnapi.news(null,function(e){u=!1,e&&!e.error?i(e):o()},function(e){u=!1,o()})))},
reload:function(){amplify.store("news-latest",null),amplify.store("next",null),hnapi.number=1,y.news.render({})},more:function(n){var e;n.classList.contains("loading")||(n.classList.add("loading"),amplify.store("hacker-news2"),e=amplify.store("next"),hnapi.news(e,function(e){n.classList.remove("loading");var t=n.parentNode;t&&(t.parentNode&&t.parentNode.removeChild(t),e&&(e=e.slice(),e=y.news.markupStories(e),c("hwlist").insertAdjacentHTML("beforeend",e),e=amplify.store("next"),c("hwlist"
...
;localStorage.setItem(o,e),a(e)}):setTimeout(e,1e3)}()},e.hw=y,ruto.config({before:function(e,t){y.hideAllViews();var n=c("view-"+t);n.classList.remove("hidden"),y.currentView=t,y.setTitle(n.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){y.comments.render(t)})}(window),function(n){function a(e){var t=e.in,n=e.out,i=t.classList,r=n.classList,n=e.direction,o=e.fn,s=u[n],a=function(){
t.removeEventListener("webkitAnimationEnd",a,!1),c.classList.remove("viewport-flip"),r.add("hidden"),i.remove("flip"),r.remove("flip"),r.remove(s[0]),i.remove(s[1]),o&&o.apply()};c.classList.add("viewport-flip"),i.remove("hidden"),r.add("flip"),i.add("flip"),t.addEventListener("webkitAnimationEnd",a,!1),r.add(s[0]),i.add(s[1])}function l(e){var t=e.in,n=e.out,i=t.classList,r=n.classList,o=t.getElementsByTagName("header")[0],n=n.getElementsByTagName("header")[0],s=o.classList,a=n.classList,
n=e.direction,l=e.fn,c=f[n],u=function(){r.add("hidden"),t.removeEventListener("webkitAnimationEnd",u,!1),r.remove("sliding"),i.remove("sliding"),r.remove(c[0]),i.remove(c[1]),s.remove("transparent"),a.remove("transparent"),l&&l.apply()};i.remove("hidden"),r.add("sliding"),i.add("sliding"),t.addEventListener("webkitAnimationEnd",u,!1),s.add("transparent"),a.add("transparent"),r.add(c[0]),i.add(c[1])}function t(){return 640<=n.innerWidth?"wide":"narrow"}var o=n.document,c=o.body,u={clockwise:[
"flip-out-to-left","flip-in-from-left"],anticlockwise:["flip-out-to-right","flip-in-from-right"]},f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},e=o.querySelector("meta[name=viewport]");e||((e=o.createElement("meta")).name="viewport",o.head.appendChild(e)),e.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var e=navigator.userAgent,s=e&&/iPhone|iPod/.test(e),i=parseInt((e.match(
/ OS (\d+)_/i)||[,0])[1],10)<6;s&&i&&c.classList.add("ios5");var d="wide"==t();n.addEventListener("resize",function(){var e="wide"==t();e!=d&&(d=e,location.reload())}),c.insertAdjacentHTML("beforeend",d?'<div id="overlay" class="hide"></div>':'<header class="fake"></header>'),ruto.config({before:function(e,t,n){var i,r=hw.currentView,o=hw.hideAllViews,s=$("view-"+t);switch(hw.setTitle(s.querySelector("header h1").textContent),t){case"home":d?(o(),$("overlay").classList.add("hide"),
s.classList.remove("hidden"),(i=$("view-comments")).classList.remove("hidden"),i.querySelector("section").innerHTML='<div class="view-blank-state"><div class="view-blank-state-text">No Story Selected.</div></div>',i.querySelector("header h1").innerHTML="",i.querySelector("header a.header-back-button").style.display="none",hw.comments.currentID=null,hw.pub("selectCurrentStory")):r?"about"==r?a({in:s,out:$("view-"+r),direction:"anticlockwise"}):"home"!=r&&l({in:s,out:$("view-"+r),direction:"ltr"}
...
).classList.remove("hidden"),hw.pub("selectCurrentStory",n[1]),s.querySelector("header a.header-back-button").style.display=""):r?"comments"!=r&&((i=n[1])&&hw.comments.currentID!=i&&(s.querySelector("section").scrollTop=0),l({in:s,out:$("view-"+r),direction:"rtl"})):(o(),s.classList.remove("hidden")),hw.currentView="comments"}}}),n.addEventListener("pagehide",function(){for(var e=o.querySelectorAll(".view"),t={},n=0,i=e.length;n<i;n++){var r=e[n];t[r.id]=r.querySelector(".scroll section"
).scrollTop||0}amplify.store("hacker-scrolltops",t)},!1);var r,e=function(){var t=amplify.store("hacker-scrolltops");setTimeout(function(){for(var e in t)$(e).querySelector(".scroll section").scrollTop=t[e]},1)};n.addEventListener("pageshow",e,!1),e(),s&&(b=o.querySelectorAll(".view>.scroll"),r=null,Array.prototype.forEach.call(b,function(e){e.addEventListener("touchstart",function(){var e;n.innerHeight!=r&&(n.scrollTo(0,0),i&&((e=o.createElement("div")).style.height="600px",c.appendChild(e),
setTimeout(function(){c.removeChild(e)},100)),r=n.innerHeight)},!1)})),tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(e,t){t=t.hash;d&&/about/i.test(ruto.current)&&"#/"==t?ruto.back("/"):location.hash=t}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var h,m=!1;tappable(".view>header h1",{onTap:function(e,t){var n,i,r=t.parentNode.nextElementSibling.firstElementChild;0==r.scrollTop||m?s&&(n=c.style.height,c.style.height="100%",setTimeout(function(
){c.style.height=n},100)):m||(m=!0,i=r.style.overflow,r.style.overflow="hidden",setTimeout(function(){r.style.overflow=i;var e=new TWEEN.Tween({scrollTop:r.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){r.scrollTop=this.scrollTop}).onComplete(function(){cancelAnimationFrame(n),e.stop(),m=!1,delete e}).start(),t=function(){TWEEN.update(),requestAnimationFrame(t)},n=requestAnimationFrame(t)},200))}}),tappable("#view-home .tableview-links li>a:first-child",{
allowClick:!d,activeClassDelay:100,inactiveClassDelay:d?100:1e3,onStart:function(e,t){var n;!d||(n=t.parentNode)&&(n=n.parentNode,h=setTimeout(function(){n&&n.classList.add("list-tapped")},100))},onMove:function(){d&&clearTimeout(h)},onEnd:function(e,t){var n;d&&(clearTimeout(h),n=t.parentNode.parentNode,setTimeout(function(){n&&n.classList.remove("list-tapped")},100))},onTap:function(e,t){t.classList.contains("more-link")?hw.news.more(t):/^#\//.test(t.getAttribute("href")
)?location.hash=t.hash:t.href&&d&&n.open(t.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure",{noScroll:!0,noScrollDelay:100,onTap:function(e,t){location.hash=t.hash}}),tappable("button.comments-toggle",function(e,t){hw.comments.toggle(t)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(e){if(d){
e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),i=n.querySelectorAll("a[href].selected"),r=0,o=i.length;r<o;r++)i[r].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")});function p(){var e,t=o.querySelector("#view-comments section");t&&(
e=t.querySelector(".post-content"),t.querySelector(".comments")&&(t=t.offsetHeight-e.offsetHeight+1,(e=$("comment-section-style"))||((e=o.createElement("style")).id="comment-section-style",o.head.appendChild(e)),e.textContent=".view section.comments{min-height: "+t+"px;}"))}hw.sub("onRenderComments",function(){setTimeout(p,d?1:360)}),n.addEventListener("resize",p,!1),n.addEventListener("orientationchange",p,!1);var v=void 0!==n.orientation,b=function(){v&&(c.style.height=screen.height+"px",
setTimeout(function(){n.scrollTo(0,0),c.style.height=n.innerHeight+"px"},1))};d||("complete"==o.readyState?b():n.addEventListener("load",b,!1),v&&(n.onorientationchange=b)),hw.news.options.disclosure=!d,hw.init()}(window);
