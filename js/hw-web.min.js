...
amplify.store("num_visits",b);var v=Number.MAX_SAFE_INTEGER,g=1;function y(e){var t=[],n={visit_count:b,time_ago:relativeDate(1e3*h),type:"visit"};for(i=0;i<e.length;i++){h<v&&h>=e[i].date&&t.push(n),v=e[i].date;var r={id:(r=e[i]).id,title:r.link_text,url:r.link,domain:r.source,points:r.points,user:r.submitter,time_ago:relativeDate(1e3*r.date),time:r.date,comments_count:r.comments,type:"link"};r.i=g++,t.push(r)}return t}e.news=function(e,n,t){var i="news-"+(e=e||"latest"),
...
"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b("disclosure")}),e.pop()),i.b(" "),i.s(i.f("selected",e,t,1),e,t,0,209,217,"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b("selected")}),e.pop()),i.b('"><div class="story"><b>'),i.b(i.v(i.f("title",e,t,0))),i.b("</b>"),i.s(i.f("user",e,t,1),e,t,0,276,595,"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b('<div class="metadata">'),n.s(n.f("domain",e,t,1),e,t,0,309,383,"{{ }}")&&(n.rs(e,t,function(e,t,n){n.b('<div class="link-text"><span class="number">#'),n.b(n.v(n.f("i",e,t,0
))),n.b(" </span>"),n.b(n.v(n.f("domain",e,t,0))),n.b("</div>")}),e.pop()),n.b('<span class="inline-block">'),n.b(n.v(n.f("points",e,t,0))),n.b(" "),n.b(n.v(n.f("i_point",e,t,0))),n.b(" by "),n.b(n.v(n.f("user",e,t,0))),n.b('</span> <span class="inline-block">'),n.b(n.v(n.f("time_ago",e,t,0))),n.s(n.f("comments_count",e,t,1),e,t,0,521,563,"{{ }}")&&(n.rs(e,t,function(e,t,n){n.b(" &middot; "),n.b(n.v(n.f("comments_count",e,t,0))),n.b(" "),n.b(n.v(n.f("i_comment",e,t,0)))}),e.pop()),n.b(
"</span></div>")}),e.pop()),i.s(i.f("user",e,t,1),e,t,1,0,0,"")||(i.b('<div class="metadata">'),i.s(i.f("domain",e,t,1),e,t,0,646,726,"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b('<span class="link-text"><span class="number">#'),n.b(n.v(n.f("i",e,t,0))),n.b(" </span>"),n.b(n.v(n.f("domain",e,t,0))),n.b("</span><br>")}),e.pop()),i.b('<span class="inline-block">'),i.b(i.v(i.f("time_ago",e,t,0))),i.b("</span></div>")),i.b("</div></a>"),i.s(i.f("detail_disclosure",e,t,1),e,t,0,830,898,"{{ }}")&&(i.rs(e,t
,function(e,t,n){n.b('<a href="'),n.b(n.v(n.f("url",e,t,0))),n.b('" class="detail-disclosure-button"><span></span></a>')}),e.pop()),i.b("</li>"),i.fl()},partials:{},subs:{}}),"stories-load":new e({code:function(e,t,n){var i=this;return i.b(n=n||""),i.s(i.f("loading",e,t,1),e,t,0,12,82,"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),e.pop()),i.s(i.f("load_error",e,t,1),e,t,0,109,161,"{{ }}")&&(i.rs(e,t,function(e,t,n){n.b(
'<div class="load-error">Couldn\'t load stories.</div>')}),e.pop()),i.fl()},partials:{},subs:{}}),visit:new e({code:function(e,t,n){var i=this;return i.b(n=n||""),i.b('<li>    <a>        <div class="number"></div>        <div class="story">            <b>Last refreshed: '),i.b(i.v(i.f("time_ago",e,t,0))),i.b('</b>            <span class="metadata">                '),i.b(i.v(i.f("visit_count",e,t,0))),i.b(" "),i.b(i.v(i.f("i_visit",e,t,0))),i.b(
" total            </span>        </div>    </a></li>"),i.fl()},partials:{},subs:{}})}}(Hogan.Template),function(e){var g=e.document,u=e.$=function(e){return g.getElementById(e)},o={},y={pub:function(e,t){var n=o[e];if(n)for(var i=0,r=n.length;i<r;i++)n[i].call(this,t)},sub:function(e,t){o[e]||(o[e]=[]),o[e].push(t)},currentView:null,hideAllViews:function(){for(var e=g.querySelectorAll(".view"),t=0,n=e.length;t<n;t++)e[t].classList.add("hidden")},tmpl:function(e,t){e=TEMPLATES[e];if(e
)return t?e.render(t):e},setTitle:function(e){var t="HckrWeb";e&&(e=e.replace(/^\s+|\s+$/g,"")).toLowerCase()!=t.toLowerCase()&&(t=e+" – "+t),document.title=t}};"undefined"!=typeof ga&&y.sub("logAPIError",function(e){ga("send","event","Errors","API",e)});var w=y.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);function _(e){var t=a[e];if(t)return t;s.href=e;var n=s.hostname.replace(/^www\./,""),i=(
r=s.pathname.replace(/^\//,"").split("/")[0]).length,r=n.length<=25&&3<i&&i<=15&&/^[^0-9][^.]+$/.test(r)?"/"+r:"";return a[e]=t=n+r}var s=g.createElement("a"),a={},l=g.querySelector("#view-home .scroll").querySelector("section"),c=!1;y.news={options:{disclosure:!0},markupStory:function(e){return/^item/i.test(e.url)?e.url="#/item/"+e.id:(e.external=!0,e.domain=_(e.url)),y.news.options.disclosure?("link"==e.type&&(e.detail_disclosure=!0),/^#\//.test(e.url)&&(e.detail_disclosure=!1,e.disclosure=!0,
e.domain=null)):e.id&&(e.url="#/item/"+e.id),e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments","visit"==e.type?(e.i_visit=1==e.visit_count?"refresh":"refreshes",w("visit",e)):w("post",e)},markupStories:function(e,t){var n="";var i=y.news.markupStory;return e.forEach(function(e){n+=i(e)}),n},updateStory:function(e){if(e&&e.id){var n,i,t=e.id,r=e.data,e="hacker-news",o=amplify.store(e);if(o)for(var s=0,a=o.length;s<a;s++)if(t==(l=o[s]).id){n=l;break}if(
!n&&(e="hacker-news2",o=amplify.store(e)))for(var l,s=0,a=o.length;s<a;s++)if(t==(l=o[s]).id){n=l;break}n&&(i=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=r[e];n[e]!=t&&(n[e]=t,i=!0)}),i&&(amplify.store(e,o),(e=u("story-"+t))&&(n.selected=!!e.querySelector("a[href].selected"),n.i=e.dataset?e.dataset.index:e.getAttribute("data-index"),e.insertAdjacentHTML("afterend",y.news.markupStory(n)),e.parentNode.removeChild(e))))}},render:function(e){var t,n,i,r,o;c||(
e=e||{},t=amplify.store("hacker-news-cached"),n=w("stories-load"),i=function(e){var t=e.slice(),e=amplify.store("next"),e='<ul class="tableview tableview-links" id="hwlist">'+y.news.markupStories(t)+'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"><i class="icon-loading"></i></span></a></li></ul>';l.innerHTML=e,y.pub("onRenderNews")},t?(r=amplify.store("hacker-news"),(e=e.delay)?(c=!0,l.innerHTML=n.render({loading:!0}),setTimeout(function(){c=!1,i(r)},e)):i(r)):(c=!0,
l.innerHTML=n.render({loading:!0}),o=function(){l.innerHTML=n.render({load_error:!0}),y.pub("logAPIError","news")},hnapi.news(null,function(e){c=!1,e&&!e.error?i(e):o()},function(e){c=!1,o()})))},reload:function(){amplify.store("news-latest",null),amplify.store("next",null),hnapi.number=1,y.news.render({})},more:function(n){var e;n.classList.contains("loading")||(n.classList.add("loading"),amplify.store("hacker-news2"),e=amplify.store("next"),hnapi.news(e,function(e){n.classList.remove("loading"
);var t=n.parentNode;t&&(t.parentNode&&t.parentNode.removeChild(t),e&&(e=e.slice(),e=y.news.markupStories(e),u("hwlist").insertAdjacentHTML("beforeend",e),e=amplify.store("next"),u("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip; ('+e+') <span class="loader"></span></a></li>')))}))}};var t=u("view-comments"),S=t.querySelector("header h1"),k=t.querySelector("section");y.comments={currentID:null,render:function(t){if(t){var e=amplify.store.sessionStorage(
...
y.setTitle(n.title),S.innerHTML=n.title;var e=i.render(n,{comments_list:e}),s=g.createElement("div");s.innerHTML=e;for(var a=s.querySelectorAll("a"),l=0,u=a.length;l<u;l++)a[l].target="_blank";var c=n.user;if(c)for(var f=s.querySelectorAll(".user"),l=0,u=f.length;l<u;l++){var d=f[l];d.textContent.trim()==c&&(d.classList.add("op"),d.title="Original Poster")}if(2e4<e.length)for(var p=s.querySelectorAll(".comments>ul>li>ul"),m=w("comments-toggle"),h=0,u=p.length;h<u;h++){var b=p[h],
v=b.querySelectorAll(".metadata").length;b.style.display="none",v&&b.insertAdjacentHTML("beforebegin",m.render({comments_count:v,i_reply:1==v?"reply":"replies"}))}for(;k.hasChildNodes();)k.removeChild(k.childNodes[0]);for(;s.hasChildNodes();)k.appendChild(s.childNodes[0]);delete s,y.pub("onRenderComments")}if(e)k.scrollTop=0,n(e,t);else{var i=amplify.store("hacker-news");if(i)for(var r=0,o=i.length;r<o;r++){var s=i[r];if(t==s.id){e=s;break}}if(!e)if(i=amplify.store("hacker-news2"))for(r=0,
...
;t&&(e=t.style,t=k.scrollTop,e.display="none"==e.display?"":"none",k.scrollTop=t)},reload:function(){y.comments.currentID=null,ruto.reload()}},y.init=function(){amplify.store("next",null),y.news.render(),ruto.init(),function e(){var t,n,i,r,o,s=Array.from(document.styleSheets).find(function(e){return/hw.*\.css/i.test(e.href)});function a(e){"dark"===e?(t.media.mediaText="screen",i.content="dark"):"light"===e?(t.media.mediaText="not all",i.content="light"):(
