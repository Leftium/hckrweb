...
a?(amplify.store(f,a,{expires:h}),e(a)):d(null)})}))},a.hnapi=q}(window),function(a){var b=a.document,c=function(a,c){var d=b.documentElement,e=d.matchesSelector||d.mozMatchesSelector||d.webkitMatchesSelector||d.oMatchesSelector||d.msMatchesSelector;return e.call(a,c)},d=function(a,b){var d=!1;do d=c(a,b);while(!d&&(a=a.parentNode)&&a.ownerDocument);return!!d&&a};a.ibento=function(a,c,e){var f=b.body;f.addEventListener(c,function(b){var c=d(b.target,a);c&&e.call(f,b,c)})}}(window);var relativeDate=function(a){
