...
var e=a<n-1?function(){o(a+1,b,c,d)}:d;k(l[a]+b,c,e)},p=function(a,b,c){k(l[0]+a,b,function(){o(0,a,b,c)})},q={urls:l,_news:function(a,b){p("news",a,b)},_news2:function(a,b){p("news2",a,b)},item:function(a,b,c){p("item/"+a,b,c)},comments:function(a,b,c){p("comments/"+a,b,c)}},r=[],s=[];q.news=function(a){entries=null,b("//hckrnews.com/data/latest.js?"+e(),function(){entries?(d(entries),a(r)):a(null)})},q.news2=function(a){a(entries?s:null)},a.hnapi=q}(window),function(a){var b=a.document,c=function(a,c){
var d=b.documentElement,e=d.matchesSelector||d.mozMatchesSelector||d.webkitMatchesSelector||d.oMatchesSelector||d.msMatchesSelector;return e.call(a,c)},d=function(a,b){var d=!1;do d=c(a,b);while(!d&&(a=a.parentNode)&&a.ownerDocument);return!!d&&a};a.ibento=function(a,c,e){var f=b.body;f.addEventListener(c,function(b){var c=d(b.target,a);c&&e.call(f,b,c)})}}(window);var relativeDate=function(a){function b(b,c){!c&&(c=(new Date).getTime()),c instanceof Date&&(c=c.getTime()),b instanceof Date&&(b=b.getTime());
var d,e,f,g=c-b;for(e=-1,f=j.length;++e<f;)if(d=j[e],g<d[0])return d[2]==a?d[1]:Math.round(g/d[2])+" "+d[1]}var c=1e3,d=60*c,e=60*d,f=24*e,g=7*f,h=365*f,i=h/12,j=[[.7*d,"just now"],[1.5*d,"a minute ago"],[60*d,"minutes ago",d],[1.5*e,"an hour ago"],[f,"hours ago",e],[2*f,"yesterday"],[7*f,"days ago",f],[1.5*g,"a week ago"],[i,"weeks ago",g],[1.5*i,"a month ago"],[h,"months ago",i],[1.5*h,"a year ago"],[Number.MAX_VALUE,"years ago",h]];return b}();"undefined"!=typeof module&&module.exports&&(module.exports=relativeDate),
function(a){TEMPLATES={"comments-toggle":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<button class="comments-toggle">'),d.b(d.v(d.f("comments_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_reply",a,b,0))),d.b("</button>"),d.fl()},partials:{},subs:{}}),comments:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("comments",a,b,1),a,b,0,13,418,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<li><p class="metadata '),c.s(c.f("deleted",a,b,1),a,b,0,48,55,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b("deleted")}),a.pop()),c.b('">'),c.s(c.f("deleted",a,b,1),a,b,0,81,103,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b("<span>[deleted]</span>")}),a.pop()),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b('<a href="https://news.ycombinator.com/user?id='),c.b(c.v(c.f("user",a,b,0))),c.b('" target="_blank"><b class="user">'),c.b(c.v(c.f("user",a,b,0))),c.b("</b></a>")),c.b('<time><a href="https://news.ycombinator.com/item?id='),c.b(c.v(c.f("id",a,b,0))),c.b('" target="_blank">'),c.b(c.v(c.f("time_ago",a,b,0))),
c.b("</a></time></p>"),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b("<p>"),c.b(c.t(c.f("content",a,b,0))),c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")),c.b("</li>")}),a.pop()),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),"post-comments":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<div class="post-content">'),d.s(d.f("has_post",a,b,1),a,b,0,39,573,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<header><a href="'),c.b(c.v(c.f("url",a,b,0))),
c.b('" target="_blank"><h1>'),c.b(c.v(c.f("title",a,b,0))),c.b("</h1>"),c.s(c.f("user",a,b,1),a,b,0,108,171,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.s(c.f("domain",a,b,1),a,b,0,119,160,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop())}),a.pop()),c.b('</a><p class="metadata">'),c.s(c.f("user",a,b,1),a,b,0,213,408,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),
c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,340,382,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span>")}),a.pop()),c.s(c.f("user",a,b,1),a,b,1,0,0,"")||(c.b('<span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</span>")),c.b('<a href="'),c.b(c.v(c.f("hn_url",a,b,0))),c.b('" target="_blank" class="external-link">'),
c.b(c.v(c.f("short_hn_url",a,b,0))),c.b("</a></p></header>")}),a.pop()),d.s(d.f("has_content",a,b,1),a,b,0,602,925,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<section class="grouped-tableview">'),c.b(c.t(c.f("content",a,b,0))),c.s(c.f("has_poll",a,b,1),a,b,0,663,902,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<ul class="poll">'),c.s(c.f("poll",a,b,1),a,b,0,689,888,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<li title="'),c.b(c.v(c.f("percentage",a,b,0))),c.b('%"><span class="poll-details"><b>'),c.b(c.v(c.f("item",a,b,0))),
c.b('</b> <span class="points">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b('</span></span><div class="poll-bar"><span style="width: '),c.b(c.v(c.f("width",a,b,0))),c.b('"></span></div></li>')}),a.pop()),c.b("</ul>")}),a.pop()),c.b("</section>")}),a.pop()),d.b('</div><section class="comments">'),d.s(d.f("loading",a,b,1),a,b,0,985,1055,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,1082,1165,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b('<div class="load-error">Couldn\'t load comments.<br><button>Try again</button></div>')}),a.pop()),d.s(d.f("loading",a,b,1),a,b,1,0,0,"")||d.s(d.f("load_error",a,b,1),a,b,1,0,0,"")||(d.s(d.f("has_comments",a,b,1),a,b,0,1224,1251,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")}),a.pop()),d.s(d.f("has_comments",a,b,1),a,b,1,0,0,"")||d.b('<p class="no-comments">No comments.</p>')),d.b("</section>"),d.fl()},partials:{"<comments_list0":{name:"comments_list",
partials:{},subs:{}}},subs:{}}),post:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<li id="story-'),d.b(d.v(d.f("id",a,b,0))),d.b('" data-index="'),d.b(d.v(d.f("i",a,b,0))),d.b('" class="post-'),d.b(d.v(d.f("type",a,b,0))),d.b('"><a href="#/item/'),d.b(d.v(d.f("id",a,b,0))),d.b('" class="'),d.s(d.f("detail_disclosure",a,b,1),a,b,0,116,133,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,170,180,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,209,217,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,307,591,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,340,379,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<div class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),
c.b("</div>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,517,559,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></div>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<div class="metadata">'),
d.s(d.f("domain",a,b,1),a,b,0,642,687,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></div>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,791,859,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},
subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>')}),a.pop()),d.fl()},partials:{},subs:{}}),visit:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<li>    <a>        <div class="number"></div>        <div class="story">            <b>Last refreshed: '),
d.b(d.v(d.f("time_ago",a,b,0))),d.b('</b>            <span class="metadata">                '),d.b(d.v(d.f("visit_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_visit",a,b,0))),d.b(" total            </span>        </div>    </a></li>"),d.fl()},partials:{},subs:{}})}}(Hogan.Template),function(a){var b=a.document,c=a.$=function(a){return b.getElementById(a)},d={},e=function(a){var b={};for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},f={pub:function(a,b){var c=d[a];if(c)for(var e=0,f=c.length;e<f;e++)c[e].call(this,b);
...
},f=function(){var a=location.hash.slice(1),b=d[a]=e(),c="hacker-scrolltop-"+a;amplify.store.sessionStorage(c,b)};a.addEventListener("scroll",function(){clearTimeout(b),b=setTimeout(f,500)},!1),ruto.config({on:function(){var b=location.hash.slice(1),c="hacker-scrolltop-"+b,f=amplify.store.sessionStorage(c);a.scrollTo(0,d[b]||f||0),f=d[b]=e(),amplify.store.sessionStorage(c,f)}});var g=c.head||c.getElementsByTagName("head")[0],h=function(){var b=a.innerHeight,d=$("view-height");d||(d=c.createElement("style"),
d.id="view-height",g.appendChild(d)),a.innerWidth>=788&&(b*=.9),d.textContent=".view>.scroll{min-height: "+b+"px}"};if(a.addEventListener("resize",h,!1),a.addEventListener("orientationchange",h,!1),h(),ibento("#view-home-refresh","click",hw.news.reload),ibento("#view-home .more-link","click",function(a,b){hw.news.more(b)}),ibento("button.comments-toggle","click",function(a,b){hw.comments.toggle(b)}),ibento("#view-comments .load-error button","click",hw.comments.reload),/Mobile;.*Firefox/.test(navigator.userAgent)&&navigator.mozApps){
var i=navigator.mozApps.getSelf();i.onsuccess=function(){i.result&&ibento('a[href]:not([href^="#"])',"click",function(a,b){a.preventDefault(),window.open(b.href,"browser")})}}window.onload=hw.init}}(window);
