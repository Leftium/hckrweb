...
}}("undefined"!=typeof exports?exports:Hogan),function(a){function b(a,b){var c=document.createElement("script");c.src=a;var d=document.getElementsByTagName("head")[0],e=!1;c.onload=c.onreadystatechange=function(){e||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(e=!0,b(),c.onload=c.onreadystatechange=null,d.removeChild(c))},d.appendChild(c)}function c(a){return{id:a.id,title:a.link_text,url:a.link,domain:a.source,points:a.points,user:a.submitter,time_ago:relativeDate(1e3*a.date),comments_count:a.comments,type:"link"}
}function d(a){s=[],t=[];var b=Math.floor(new Date/1e3),d=amplify.store("last_visit")||b,e=amplify.store("num_visits")||0;e++,amplify.store("last_visit",b),amplify.store("num_visits",e);for(var f=0;f<a.length&&a[f].date>d;){var g=c(a[f]);f++,g.i=f,s.push(g)}for(s.push({visit_count:e,time_ago:relativeDate(1e3*d),type:"visit"});f<a.length;){var g=c(a[f]);f++,g.i=f,t.push(g)}}var e=function(){return+new Date},f=!!a.XDomainRequest,g="withCredentials"in new XMLHttpRequest||f,h=!1,i=2e4,j={};try{h=new Worker("js/hnapi-worker.js"),h.addEventListener("message",function(a){var b=a.data,c=b.url||"";
if(j[c]){var d=j[c],e=d.error,f=d.success;delete j[c],b.error?e(b.error):f(b.response)}},!1)}catch(k){}var l=function(b,c,d){if(c||(c=function(){}),d||(d=function(){}),g)if(h)j[b]={success:c,error:d},h.postMessage({url:b,timeout:i});else{var k=j[b]||(f?new XDomainRequest:new XMLHttpRequest);k._timeout&&clearTimeout(k._timeout),k._timeout=setTimeout(function(){k.abort()},i),k.onload=function(){clearTimeout(this._timeout),delete j[b];try{c(JSON.parse(this.responseText))}catch(a){d(a)}},k.onerror=k.onabort=k.ontimeout=function(a){clearTimeout(this._timeout),delete j[b],d(a)
},(k.readyState<=1||f)&&(k.open("GET",b+"?"+e(),!0),k.send()),j[b]=k}else{var l=a.document,m=l.createElement("script"),n="callback"+e();a[n]=c,m.onerror=d,m.src=b+"?callback="+n,l.body.appendChild(m)}},m=["//node-hnapi-eu.herokuapp.com/","//node-hnapi.azurewebsites.net/","//node-hnapi-asia.azurewebsites.net/","//node-hnapi-eus.azurewebsites.net/","//node-hnapi-weu.azurewebsites.net/","//node-hnapi-wus.azurewebsites.net/","//node-hnapi-ncus.azurewebsites.net/"],n=function(a){for(var b=a.length-1;b>0;b--){var c=Math.floor(Math.random()*(b+1)),d=a[b];
a[b]=a[c],a[c]=d}};n(m);var o=m.length,p=function(a,b,c,d){var e=o-1>a?function(){p(a+1,b,c,d)}:d;l(m[a]+b,c,e)},q=function(a,b,c){l(m[0]+a,b,function(){p(0,a,b,c)})},r={urls:m,_news:function(a,b){q("news",a,b)},_news2:function(a,b){q("news2",a,b)},item:function(a,b,c){q("item/"+a,b,c)},comments:function(a,b,c){q("comments/"+a,b,c)}},s=[],t=[];r.news=function(a){entries=null,b("http://hckrnews.com/data/latest.js?"+e(),function(){entries?(d(entries),a(s)):a(null)})},r.news2=function(a){a(entries?t:null)
},a.hnapi=r}(window),function(a){var b=a.document,c=function(a,c){var d=b.documentElement,e=d.matchesSelector||d.mozMatchesSelector||d.webkitMatchesSelector||d.oMatchesSelector||d.msMatchesSelector;return e.call(a,c)},d=function(a,b){var d=!1;do d=c(a,b);while(!d&&(a=a.parentNode)&&a.ownerDocument);return d?a:!1};a.ibento=function(a,c,e){var f=b.body;f.addEventListener(c,function(b){var c=d(b.target,a);c&&e.call(f,b,c)})}}(window),"document"in self&&!("classList"in document.createElement("_"))&&!function(a){"use strict";
if("Element"in a){var b="classList",c="prototype",d=a.Element[c],e=Object,f=String[c].trim||function(){return this.replace(/^\s+|\s+$/g,"")},g=Array[c].indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(b in this&&this[b]===a)return b;return-1},h=function(a,b){this.name=a,this.code=DOMException[a],this.message=b},i=function(a,b){if(""===b)throw new h("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(b))throw new h("INVALID_CHARACTER_ERR","String contains an invalid character");
...
}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,170,180,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,209,217,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,307,599,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,341,386,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")
}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,524,566,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></span>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<span class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,651,696,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")
}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></span>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,801,869,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')
